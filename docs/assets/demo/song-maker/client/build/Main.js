! function(t) {
    ...
    function l(t, e, n, i) {
        var r, s, o, a;
        if (u(n), void 0 === (s = t._events) ? (s = t._events = Object.create(null), t._eventsCount = 0) : (void 0 !== s.newListener && (t.emit("newListener", e, n.listener ? n.listener : n), s = t._events), o = s[e]), void 0 === o) o = s[e] = n, ++t._eventsCount;
        else if ("function" == typeof o ? o = s[e] = i ? [n, o] : [o, n] : i ? o.unshift(n) : o.push(n), (r = h(t)) > 0 && o.length > r && !o.warned) {
            o.warned = !0;
    ...
    ! function(r) {
        ...
        function d(t, e) {
            ...
            var n = function(t) {
                ...
                "object" == typeof t && (G(t.r) && G(t.g) && G(t.b) ? (p = t.r, f = t.g, m = t.b, e = {
                    ...
                    if (t = P(t, 360), e = P(e, 100), n = P(n, 100), 0 === e) i = r = s = n;
                    else {
                        var a = n < .5 ? n * (1 + e) : n + e - n * e,
                            c = 2 * n - a;
                        i = o(c, a, t + 1 / 3), r = o(c, a, t), s = o(c, a, t - 1 / 3)
                    }
                    return {
                        r: 255 * i,
                        g: 255 * r,
        ...
        function O(t, e, n) {
            ...
            var i = d(t).toHsl(),
                r = 360 / n,
                s = [d(t)];
            for (i.h = (i.h - (r * e >> 1) + 720) % 360; --e;) i.h = (i.h + r) % 360, s.push(d(i));
            return s
        }

        function M(t, e) {
            e = e || 6;
            for (var n = d(t).toHsv(), i = n.h, r = n.s, s = n.v, o = [], a = 1 / e; e--;) o.push(d({
                h: i,
                s: r,
                v: s
            })), s = (s + a) % 1;
        ...
        d.prototype = {
            ...
            var i, r, s, o, a = null,
                c = 0;
            r = (n = n || {}).includeFallbackColors, s = n.level, o = n.size;
    ...
    const hn = Object(E.a)(new Map, new WeakMap),
        ...
        wr = (Object(Mt.a)(ft.a, fe.a, Le.a, Ii, fn), Object(F.a)(fe.a, dn)),
        xr = Object(Ce.a)(An, hn, bn, lr, Ci, on.a, Pn, Dn),
        Tr = (Object(It.a)(hn, ft.a, wr, Ii, xr), Object(me.a)(er, hn, ft.a, wr, xr)),
    ...
    (function(n) {
        ...
        var s, o = new r;
        o.Group = r, o._nextId = 0, o.nextId = function() {
            return o._nextId++
            ...
            this._object = t, this._valuesStart = {}, this._valuesEnd = {}, this._valuesStartRepeat = {}, this._duration = 1e3, this._repeat = 0, this._repeatDelayTime = void 0, this._yoyo = !1, this._isPlaying = !1, this._reversed = !1, this._delayTime = 0, this._startTime = null, this._easingFunction = o.Easing.Linear.None, this._interpolationFunction = o.Interpolation.Linear, this._chainedTweens = [], this._onStartCallback = null, this._onStartCallbackFired = !1, this._onUpdateCallback = null, this._onCompleteCallback = null, this._onStopCallback = null, this._group = e || o, this._id = o.nextId()
        }, o.Tween.prototype = {
            getId: function() {
                return this._id
            },
            ...
            start: function(t) {
                for (var e in this._group.add(this), this._isPlaying = !0, this._onStartCallbackFired = !1, this._startTime = void 0 !== t ? "string" == typeof t ? o.now() + parseFloat(t) : t : o.now(), this._startTime += this._delayTime, this._valuesEnd) {
            ...
            update: function(t) {
                ...
                for (e in !1 === this._onStartCallbackFired && (null !== this._onStartCallback && this._onStartCallback(this._object), this._onStartCallbackFired = !0), n = (n = (t - this._startTime) / this._duration) > 1 ? 1 : n, i = this._easingFunction(n), this._valuesEnd)
                    if (void 0 !== this._valuesStart[e]) {
                        var r = this._valuesStart[e] || 0,
                            s = this._valuesEnd[e];
                        s instanceof Array ? this._object[e] = this._interpolationFunction(s, i) : ("string" == typeof s && (s = "+" === s.charAt(0) || "-" === s.charAt(0) ? r + parseFloat(s) : parseFloat(s)), "number" == typeof s && (this._object[e] = r + (s - r) * i))
                    }
            ...
            Bezier: function(t, e) {
                for (var n = 0, i = t.length - 1, r = Math.pow, s = o.Interpolation.Utils.Bernstein, a = 0; a <= i; a++) n += r(1 - e, i - a) * r(e, a) * t[a] * s(i, a);
                return n
            },
            CatmullRom: function(t, e) {
                ...
                return t[0] === t[n] ? (e < 0 && (r = Math.floor(i = n * (1 + e))), s(t[(r - 1 + n) % n], t[r], t[(r + 1) % n], t[(r + 2) % n], i - r)) : e < 0 ? t[0] - (s(t[0], t[0], t[1], t[1], -i) - t[0]) : e > 1 ? t[n] - (s(t[n], t[n], t[n - 1], t[n - 1], i - n) - t[n]) : s(t[r ? r - 1 : 0], t[r], t[n < r + 1 ? n : r + 1], t[n < r + 2 ? n : r + 2], i - r)
            },
            Utils: {
    ...
    ! function(t, e, n, i) {
            ...
            T = function() {
                ...
                return i(t, [{
                    ...
                    value: function(t) {
                        ...
                        if (g(t) || v(t)) {
                            ...
                            if (-1 !== n && (this._automationEvents = this._automationEvents.slice(0, n)), g(t)) {
                                ...
                                void 0 !== c && x(c) && this._automationEvents.push(o(this.getValue(e), e)), void 0 !== c && p(c) && c.startTime + c.duration > e && (this._automationEvents[this._automationEvents.length - 1] = a(new Float32Array([6, 7]), c.startTime, e - c.startTime))
                            }
                        } else {
                    ...
                    value: function(t) {
                        ...
                        if (e > 1) {
                            var n = this._automationEvents.slice(e - 1),
                                i = n[0];
                            x(i) && n.unshift(o(f(this._automationEvents, e - 2, i.startTime, this._defaultValue), i.startTime)), this._automationEvents = n
                        }
                    }
                }, {
                    key: "getValue",
                    value: function(t) {
                        ...
                        if (void 0 !== s && x(s) && (void 0 === r || !l(r) || r.insertTime > t)) return c(t, f(this._automationEvents, i - 2, s.startTime, this._defaultValue), s);
                        if (void 0 !== s && d(s) && (void 0 === r || !l(r))) return s.value;
                        if (void 0 !== s && p(s) && (void 0 === r || !l(r) || s.startTime + s.duration > t)) return t < s.startTime + s.duration ? w(t, s) : s.values[s.values.length - 1];
                        if (void 0 !== s && l(s) && (void 0 === r || !l(r))) return s.value;
                        if (void 0 !== r && u(r)) {
        ...
        }, t.createSetValueAutomationEvent = o, t.createSetValueCurveAutomationEvent = a, Object.defineProperty(t, "__esModule", {
            value: !0
        })
    }(e, n(703), n(709), n(710))
}, function(t, e, n) {
    ...
    function g(t, e) {
        ...
        if (e.singleton) {
            var s = m++;
            n = f || (f = u(e)), i = d.bind(null, n, s, !1), r = d.bind(null, n, s, !0)
            ...
            return this.map((function(e) {
                var n = function(t, e) {
                    ...
                    if (e && "function" == typeof btoa) {
                        var r = (o = i, a = btoa(unescape(encodeURIComponent(JSON.stringify(o)))), c = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), "/*# ".concat(c, " */")),
    ...
    var i = !0,
        ...
        s = {
            ...
            detectBrowser: function(t) {
                ...
                if (e.mozGetUserMedia) n.browser = "firefox", n.version = this.extractVersion(e.userAgent, /Firefox\/(\d+)\./, 1);
                else if (e.webkitGetUserMedia)
                    if (t.webkitRTCPeerConnection) n.browser = "chrome", n.version = this.extractVersion(e.userAgent, /Chrom(e|ium)\/(\d+)\./, 2);
                    else {
                        if (!e.userAgent.match(/Version\/(\d+).(\d+)/)) return n.browser = "Unsupported webkit-based browser with GUM support but no WebRTC support.", n;
                        n.browser = "safari", n.version = this.extractVersion(e.userAgent, /AppleWebKit\/(\d+)\./, 1)
                    }
                else if (e.mediaDevices && e.userAgent.match(/Edge\/(\d+).(\d+)$/)) n.browser = "edge", n.version = this.extractVersion(e.userAgent, /Edge\/(\d+).(\d+)$/, 2);
                else {
                    if (!e.mediaDevices || !e.userAgent.match(/AppleWebKit\/(\d+)\./)) return n.browser = "Not a supported browser.", n;
                    n.browser = "safari", n.version = this.extractVersion(e.userAgent, /AppleWebKit\/(\d+)\./, 1)
                }
                return n
            }
    ...
    ! function(n) {
        ...
        r.prototype.enable = function(t, e) {
            return this.enabled ? void 0 : this.supported ? void navigator.requestMIDIAccess({
                ...
                function n() {
                    this._updateInputsAndOutputs(), this.interface.onstatechange = this._onInterfaceStateChange.bind(this), "function" == typeof t && t.call(this), i.forEach(function(t) {
                ...
                for (var s = e.inputs.values(), o = s.next(); o && !o.done; o = s.next()) r.push(o.value.open());
                for (var a = e.outputs.values(), c = a.next(); c && !c.done; c = a.next()) r.push(c.value.open());
            ...
            var e = !1;
            if (t && t.toFixed && t >= 0 && 127 >= t ? e = Math.round(t) : parseInt(t) >= 0 && parseInt(t) <= 127 ? e = parseInt(t) : ("string" == typeof t || t instanceof String) && (e = this.noteNameToNumber(t)), !1 === e) throw new Error("Invalid note number (" + t + ").");
            return e
            ...
            var n = a._semitones[e[1].toUpperCase()],
                i = parseInt(e[3]),
                r = 12 * (i + 2) + n;
            if (e[2].toLowerCase().indexOf("b") > -1 ? r -= e[2].length : e[2].toLowerCase().indexOf("#") > -1 && (r += e[2].length), 0 > n || -2 > i || i > 8 || 0 > r || r > 127) throw new RangeError("Invalid note name or note outside valid range.");
            return r
            ...
            var e = new s(t);
            return e._midiInput.onmidimessage = e._onMidiMessage.bind(e), e
        }, r.prototype._createOutput = function(t) {
            var e = new o(t);
            return e._midiOutput.onmidimessage = e._onMidiMessage.bind(e), e
            ...
            if (a.MIDI_SYSTEM_MESSAGES[t]) this._userHandlers.system[t] || (this._userHandlers.system[t] = []), this._userHandlers.system[t].push(n);
            else {
                if (!a.MIDI_CHANNEL_MESSAGES[t]) throw new TypeError("The specified event type is not supported.");
                if (e.indexOf("all") > -1) {
                    e = [];
            ...
            return this
        }, s.prototype.on = s.prototype.addListener, s.prototype.hasListener = function(t, e, n) {
            var i = this;
            if ("function" != typeof n) throw new TypeError("The 'listener' parameter must be a function.");
            if (void 0 === e && (e = "all"), e.constructor !== Array && (e = [e]), a.MIDI_SYSTEM_MESSAGES[t]) {
                ...
                e.forEach((function(e) {
                    ...
                    if (r)
                        if (void 0 === n) i._userHandlers.channel[t][e] = [];
                            ...
                            for (var s = 0; s < r.length; s++) r[s] === n && r.splice(s, 1)
                }))
            } else {
                if (void 0 !== t) throw new TypeError("The specified event type is not supported.");
                this._initializeUserHandlers()
            ...
            i === a.MIDI_CHANNEL_MESSAGES.noteoff || i === a.MIDI_CHANNEL_MESSAGES.noteon && 0 === n ? (s.type = "noteoff", s.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e)
            }, s.velocity = n / 127, s.rawVelocity = n) : i === a.MIDI_CHANNEL_MESSAGES.noteon ? (s.type = "noteon", s.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e)
            }, s.velocity = n / 127, s.rawVelocity = n) : i === a.MIDI_CHANNEL_MESSAGES.keyaftertouch ? (s.type = "keyaftertouch", s.note = {
                number: e,
                name: a._notes[e % 12],
                octave: a.getOctave(e)
            }, s.value = n / 127) : i === a.MIDI_CHANNEL_MESSAGES.controlchange && e >= 0 && 119 >= e ? (s.type = "controlchange", s.controller = {
                number: e,
                name: this.getCcNameByNumber(e)
            }, s.value = n) : i === a.MIDI_CHANNEL_MESSAGES.channelmode && e >= 120 && 127 >= e ? (s.type = "channelmode", s.controller = {
                number: e,
                name: this.getChannelModeByNumber(e)
            }, s.value = n) : i === a.MIDI_CHANNEL_MESSAGES.programchange ? (s.type = "programchange", s.value = e) : i === a.MIDI_CHANNEL_MESSAGES.channelaftertouch ? (s.type = "channelaftertouch", s.value = e / 127) : i === a.MIDI_CHANNEL_MESSAGES.pitchbend ? (s.type = "pitchbend", s.value = ((n << 7) + e - 8192) / 8192) : s.type = "unknownchannelmessage", this._userHandlers.channel[s.type] && this._userHandlers.channel[s.type][r] && this._userHandlers.channel[s.type][r].forEach((function(t) {
                t(s)
            }))
        }, s.prototype.getCcNameByNumber = function(t) {
            if (!((t = parseInt(t)) >= 0 && 119 >= t)) throw new RangeError("The control change number must be between 0 and 119.");
            for (var e in a.MIDI_CONTROL_CHANGE_MESSAGES)
                if (t === a.MIDI_CONTROL_CHANGE_MESSAGES[e]) return e
        }, s.prototype.getChannelModeByNumber = function(t) {
            if (!((t = parseInt(t)) >= 120 && status <= 127)) throw new RangeError("The control change number must be between 120 and 127.");
            for (var e in a.MIDI_CHANNEL_MODE_MESSAGES)
                if (t === a.MIDI_CHANNEL_MODE_MESSAGES[e]) return e
            ...
            return e.forEach((function(t) {
                if (!(t >= 0 && 255 >= t)) throw new RangeError("The data bytes must be integers between 0 (0x00) and 255 (0xFF).");
                i.push(t)
            })), this._midiOutput.send(i, parseFloat(n) || 0), this
            ...
            if (e = e || {}, !((t = parseInt(t)) >= 0 && 127 >= t)) throw new RangeError("The song number must be between 0 and 127.");
            ...
            return t = t || {}, this.send(a.MIDI_SYSTEM_MESSAGES.activesensing, void 0, this._parseTimeParameter(t.time)), this
            ...
            var i = 64;
            return (n = n || {}).velocity = parseFloat(n.velocity), n.rawVelocity ? !isNaN(n.velocity) && n.velocity >= 0 && n.velocity <= 127 && (i = n.velocity) : !isNaN(n.velocity) && n.velocity >= 0 && n.velocity <= 1 && (i = 127 * n.velocity), this._convertNoteToArray(t).forEach(function(t) {
            ...
            var i = 64;
            if ((n = n || {}).velocity = parseFloat(n.velocity), n.rawVelocity ? !isNaN(n.velocity) && n.velocity >= 0 && n.velocity <= 127 && (i = n.velocity) : !isNaN(n.velocity) && n.velocity >= 0 && n.velocity <= 1 && (i = 127 * n.velocity), n.time = this._parseTimeParameter(n.time), this._convertNoteToArray(t).forEach(function(t) {
                    this._convertChannelToArray(e).forEach(function(e) {
                        this.send((a.MIDI_CHANNEL_MESSAGES.noteon << 4) + (e - 1), [t, Math.round(i)], n.time)
                    }.bind(this))
                }.bind(this)), n.duration = parseFloat(n.duration), n.duration) {
                n.duration <= 0 && (n.duration = 0);
                var r = 64;
                n.release = parseFloat(n.release), n.rawVelocity ? !isNaN(n.release) && n.release >= 0 && n.release <= 127 && (r = n.release) : !isNaN(n.release) && n.release >= 0 && n.release <= 1 && (r = 127 * n.release), this._convertNoteToArray(t).forEach(function(t) {
                    this._convertChannelToArray(e).forEach(function(e) {
            ...
            } else if (!((t = parseInt(t)) >= 0 && 119 >= t)) throw new RangeError("Controller numbers must be between 0 and 119.");
            if (!((e = parseInt(e) || 0) >= 0 && 127 >= e)) throw new RangeError("Controller value must be between 0 and 127.");
            ...
            var i = this;
            if (t[0] = parseInt(t[0]), !(t[0] >= 0 && t[0] <= 127)) throw new RangeError("The control65 value must be between 0 and 127");
            if (t[1] = parseInt(t[1]), !(t[1] >= 0 && t[1] <= 127)) throw new RangeError("The control64 value must be between 0 and 127");
            ...
            var i = this;
            if (t[0] = parseInt(t[0]), !(t[0] >= 0 && t[0] <= 127)) throw new RangeError("The control63 value must be between 0 and 127");
            if (t[1] = parseInt(t[1]), !(t[1] >= 0 && t[1] <= 127)) throw new RangeError("The control62 value must be between 0 and 127");
            return this._convertChannelToArray(e).forEach((function(r) {
            ...
            var i = this;
            if ((t = [].concat(t))[0] = parseInt(t[0]), !(t[0] >= 0 && t[0] <= 127)) throw new RangeError("The msb value must be between 0 and 127");
            return this._convertChannelToArray(e).forEach((function(r) {
                i.sendControlChange(6, t[0], e, {
                    time: n
                })
            })), t[1] = parseInt(t[1]), t[1] >= 0 && t[1] <= 127 && this._convertChannelToArray(e).forEach((function(r) {
            ...
            return e = [].concat(e), this._convertChannelToArray(n).forEach((function(s) {
            ...
            var r = this;
            if (i = i || {}, !((t = parseInt(t) || 0) >= 0 && 127 >= t)) throw new RangeError("The semitones value must be between 0 and 127");
            if (!((e = parseInt(e) || 0) >= 0 && 127 >= e)) throw new RangeError("The cents value must be between 0 and 127");
            return this._convertChannelToArray(n).forEach((function(s) {
            ...
            var i = this;
            if (n = n || {}, !((t = parseInt(t) || 0) >= 0 && 127 >= t)) throw new RangeError("The program value must be between 0 and 127");
            return this._convertChannelToArray(e).forEach((function(r) {
            ...
            var i = this;
            if (n = n || {}, !((t = parseInt(t) || 0) >= 0 && 127 >= t)) throw new RangeError("The bank value must be between 0 and 127");
            return this._convertChannelToArray(e).forEach((function(r) {
            ...
            } else if (!((t = parseInt(t)) >= 120 && 127 >= t)) throw new RangeError("Channel mode numerical identifiers must be between 120 and 127.");
            if (0 > (e = parseInt(e) || 0) || e > 127) throw new RangeError("Value must be an integer between 0 and 127.");
            return this._convertChannelToArray(n).forEach(function(n) {
            ...
            var i = this;
            if (n = n || {}, t = parseInt(t), isNaN(t) || 0 > t || t > 127) throw new RangeError("Program numbers must be between 0 and 127.");
            ...
            var i = this;
            if (n = n || {}, t = parseFloat(t), isNaN(t) || -1 > t || t > 1) throw new RangeError("Pitch bend value must be between -1 and 1.");
            ...
            if (("all" === t || void 0 === t) && (t = ["all"]), Array.isArray(t) || (t = [t]), t.indexOf("all") > -1) {
                t = [];
                for (var e = 1; 16 >= e; e++) t.push(e)
            }
            return t.forEach((function(t) {
                if (!(t >= 1 && 16 >= t)) throw new RangeError("MIDI channels must be between 1 and 16.")
            })), t
        }, o.prototype._onMidiMessage = function(t) {}, void 0 === (i = function() {
            return a
        }.apply(e, [])) || (t.exports = i)
    }()
}, function(t, e, n) {
    ...
    function i(t, e, n, i, r) {
        if ("function" == typeof t.copyFromChannel) 0 === e[n].byteLength && (e[n] = new Float32Array(128)), t.copyFromChannel(e[n], i, r);
            ...
            if (0 === e[n].byteLength) e[n] = s.slice(r, r + 128);
            else {
    ...
    const i = (t, e, n, i, r, s, o, a, c, u, h) => {
        ...
        for (let a = 0; a < l; a += 1) {
            ...
            for (let t = r; t < i; t += 1) l += n[t] * s[d - t & c - 1];
            for (let n = r; n < e; n += 1) l -= t[n] * o[d - n & c - 1];
            s[d] = u[a], o[d] = l, d = d + 1 & c - 1, h[a] = l
        }
        return d
    }
}, function(t, e, n) {
    ...
    t.exports = '<div class=expandable id=loading-modal> <img src=/client/images/animated-loader.svg> <div class=circle> <svg class=circular-loader viewBox="0 0 50 50"> <circle class=loader-path cx=25 cy=25 r=20 fill=none stroke-width=3 /> </svg> </div> </div> '
}, function(t, e, n) {
    "use strict";
    ...
    i.localCName = i.generateIdentifier(), i.splitLines = function(t) {
        ...
        var n = t.type;
        return e.push("typ"), e.push(n), "host" !== n && t.relatedAddress && t.relatedPort && (e.push("raddr"), e.push(t.relatedAddress), e.push("rport"), e.push(t.relatedPort)), t.tcpType && "tcp" === t.protocol.toLowerCase() && (e.push("tcptype"), e.push(t.tcpType)), t.ufrag && (e.push("ufrag"), e.push(t.ufrag)), "candidate:" + e.join(" ")
        ...
        return e = e[0].split("/"), n.name = e[0], n.clockRate = parseInt(e[1], 10), n.numChannels = 3 === e.length ? parseInt(e[2], 10) : 1, n
        ...
        for (var e = {
            ...
            if (o) {
                ...
                switch (a.parameters = c.length ? i.parseFmtp(c[0]) : {}, a.rtcpFeedback = i.matchPrefix(t, "a=rtcp-fb:" + s + " ").map(i.parseRtcpFb), e.codecs.push(a), a.name.toUpperCase()) {
                    case "RED":
                    case "ULPFEC":
        ...
        if (s += i.writeIceParameters(t.iceGatherer.getLocalParameters()), s += i.writeDtlsParameters(t.dtlsTransport.getLocalParameters(), "offer" === n ? "actpass" : "active"), s += "a=mid:" + t.mid + "\r\n", t.direction ? s += "a=" + t.direction + "\r\n" : t.rtpSender && t.rtpReceiver ? s += "a=sendrecv\r\n" : t.rtpSender ? s += "a=sendonly\r\n" : t.rtpReceiver ? s += "a=recvonly\r\n" : s += "a=inactive\r\n", t.rtpSender) {
        ...
        r = (t, e, n, r, s, o) => class extends t {
            constructor(t, n = i) {
                const a = s(t),
                    ...
                    u = r(a, c);
                super(t, !1, u, o(a) ? e() : null), this._nativeAnalyserNode = u
            }
            get fftSize() {
        ...
        return {
            render(s, o, a) {
                ...
                return void 0 !== c ? Promise.resolve(c) : (async (s, o, a) => {
                    ...
                    return r.set(o, c), await n(s, o, c, a), c
                })(s, o, a)
            }
        }
    }
        ...
        a = (t, e, n, a, c, u, h, l) => class extends t {
            ...
            start(t = 0, e = 0, n) {
                if (this._nativeAudioBufferSourceNode.start(t, e, n), null !== this._audioBufferSourceNodeRenderer) this._audioBufferSourceNodeRenderer.start = void 0 === n ? [t, e] : [t, e, n];
                    ...
                    Object(r.a)(this);
                    const t = () => {
                        this._nativeAudioBufferSourceNode.removeEventListener("ended", t), setTimeout(() => Object(s.a)(this), 1e3)
                    };
        ...
        return {
            ...
            render(u, h, l) {
                ...
                return void 0 !== d ? Promise.resolve(d) : (async (u, h, l) => {
                    ...
                    return o.set(h, d), p ? await t(h, u.playbackRate, d.playbackRate, l) : await r(h, u.playbackRate, d.playbackRate, l), await s(u, h, d, l), d
                })(u, h, l)
            }
        }
    }
    ...
    const r = (t, e, n, r, s, o, a, c, u) => class extends t {
        constructor(t = {}) {
            ...
            if (this._baseLatency = "number" == typeof e.baseLatency ? e.baseLatency : "balanced" === s ? 512 / o : "interactive" === s || void 0 === s ? 256 / o : "playback" === s ? 1024 / o : 128 * Math.max(2, Math.min(128, Math.round(s * o / 128))) / o, this._nativeAudioContext = e, this._state = null, "running" === e.state) {
        ...
        const c = a.listener,
            {
                ...
                const u = e(a, {
                    ...
                    d = (e, r) => {
                        ...
                        return s.connect(u, 0, e), s.start(), Object.defineProperty(s.offset, "defaultValue", {
                            get: () => r
                        }), t({
                            context: o
                        }, h, s.offset, i.b, i.a)
        ...
        const b = new i.AutomationEventList(m.defaultValue),
            ...
            _ = {
                ...
                cancelAndHoldAtTime(t) {
                    if ("function" == typeof m.cancelAndHoldAtTime) null === y && b.flush(p.context.currentTime), b.add(s(t)), m.cancelAndHoldAtTime(t);
                    else {
                        const e = Array.from(b).pop();
                        null === y && b.flush(p.context.currentTime), b.add(s(t));
                ...
                cancelScheduledValues: t => (null === y && b.flush(p.context.currentTime), b.add(o(t)), m.cancelScheduledValues(t), _),
    ...
    const r = {
        ...
        s = (t, e, n, s, o, a, c) => class extends t {
            ...
            getFrequencyResponse(t, e, n) {
                if (this._nativeBiquadFilterNode.getFrequencyResponse(t, e, n), t.length !== e.length || e.length !== n.length) throw s()
            }
        }
}, function(t, e, n) {
    "use strict";
        ...
        return {
            render(a, c, u) {
                ...
                return void 0 !== h ? Promise.resolve(h) : (async (a, c, u) => {
                    ...
                    return o.set(c, h), l ? (await t(c, a.Q, h.Q, u), await t(c, a.detune, h.detune, u), await t(c, a.frequency, h.frequency, u), await t(c, a.gain, h.gain, u)) : (await r(c, a.Q, h.Q, u), await r(c, a.detune, h.detune, u), await r(c, a.frequency, h.frequency, u), await r(c, a.gain, h.gain, u)), await s(a, c, h, u), h
                })(a, c, u)
            }
        }
    }
        ...
        a = (t, e, n, a, c, u, h) => class extends t {
            ...
            start(t = 0) {
                if (this._nativeConstantSourceNode.start(t), null !== this._constantSourceNodeRenderer) this._constantSourceNodeRenderer.start = t;
                    ...
                    Object(r.a)(this);
                    const t = () => {
                        this._nativeConstantSourceNode.removeEventListener("ended", t), setTimeout(() => Object(s.a)(this), 1e3)
                    };
        ...
        return {
            ...
            render(u, h, l) {
                ...
                return void 0 !== d ? Promise.resolve(d) : (async (u, h, l) => {
                    ...
                    return o.set(h, d), p ? await t(h, u.offset, d.offset, l) : await r(h, u.offset, d.offset, l), await s(u, h, d, l), d
                })(u, h, l)
            }
        }
    }
        ...
        r = (t, e, n, r, s) => class extends t {
            constructor(t, o = i) {
                const a = r(t),
                    ...
                    u = n(a, c);
                super(t, !1, u, s(a) ? e() : null), this._isBufferNullified = !1, this._nativeConvolverNode = u
            }
            get buffer() {
        ...
        return {
            render(o, a, c) {
                ...
                return void 0 !== u ? Promise.resolve(u) : (async (o, a, c) => {
                    ...
                    return s.set(a, u), Object(i.a)(u) ? await n(o, a, u.inputs[0], c) : await n(o, a, u, c), u
                })(o, a, c)
            }
        }
    }
        ...
        return {
            render(c, u, h) {
                ...
                return void 0 !== l ? Promise.resolve(l) : (async (c, u, h) => {
                    ...
                    return a.set(u, l), d ? await t(u, c.delayTime, l.delayTime, h) : await r(u, c.delayTime, l.delayTime, h), await s(c, u, l, h), l
                })(c, u, h)
            }
        }
    }
    ...
    const i = {
        ...
        r = (t, e, n, r, s, o, a) => class extends t {
            ...
            set channelCount(t) {
                ...
                if (this._nativeDynamicsCompressorNode.channelCount = t, t > 2) throw this._nativeDynamicsCompressorNode.channelCount = e, s()
            }
            get channelCountMode() {
            ...
            set channelCountMode(t) {
                ...
                if (this._nativeDynamicsCompressorNode.channelCountMode = t, "max" === t) throw this._nativeDynamicsCompressorNode.channelCountMode = e, s()
            }
            get knee() {
                return this._knee
            }
    ...
    const i = t => e => new Promise((n, i) => {
        ...
        if (null === r) i(new SyntaxError);
            ...
            t.onerror = (e, n, r, s, o) => n === a || n === t.location.href && 1 === r && 1 === s ? (u(), i(o), !1) : null !== c ? c(e, n, r, s, o) : void 0, s.onerror = () => {
                u(), i(new SyntaxError)
            }, s.onload = () => {
                u(), n()
            }, s.src = a, s.type = "module", r.appendChild(s)
        }
    })
}, function(t, e, n) {
    "use strict";
        ...
        return {
            render(a, c, u) {
                ...
                return void 0 !== h ? Promise.resolve(h) : (async (a, c, u) => {
                    ...
                    return o.set(c, h), l ? await t(c, a.gain, h.gain, u) : await r(c, a.gain, h.gain, u), await s(a, c, h, u), h
                })(a, c, u)
            }
        }
    }
    ...
    const s = (t, e, n, s, o, a) => (c, u) => {
        ...
        const d = async (d, p, f) => {
            ...
            if (void 0 === p.createIIRFilter ? m = t(p) : v || (g = e(p, t => t.createIIRFilter(u, c))), h.set(p, null === m ? g : m), null !== m) {
                if (null === l) {
                    ...
                    l = (async () => (await o(d, t, t.destination, f), ((t, e, n, r) => {
                        const s = n.length,
                            o = r.length,
                            a = Math.min(s, o);
                        if (1 !== n[0]) {
                            for (let t = 0; t < s; t += 1) r[t] /= n[0];
                            for (let t = 1; t < o; t += 1) n[t] /= n[0]
                        }
                        ...
                        for (let e = 0; e < l; e += 1) {
                            ...
                            c.fill(0), u.fill(0), Object(i.a)(n, s, r, o, a, c, u, 0, 32, l, d)
                        }
                        return h
                    })(await a(t), p, c, u)))()
                }
    ...
    const i = (t, e, n, i) => class extends t {
        constructor(t, r) {
            const s = n(t),
                o = e(s, r);
            if (i(s)) throw TypeError();
            super(t, !0, o, null), this._mediaElement = r.mediaElement, this._nativeMediaElementAudioSourceNode = o
        }
        get mediaElement() {
    ...
    const r = (t, e, n, r, s) => class extends r {
        constructor(t = {}) {
            if (null === s) throw new Error("Missing the native AudioContext constructor.");
            const r = new s(t);
            if (null === r) throw n();
            if (!Object(i.a)(t.latencyHint)) throw new TypeError(`The provided value '${t.latencyHint}' is not a valid enum value of type AudioContextLatencyCategory.`);
            ...
            if (this._baseLatency = "number" == typeof r.baseLatency ? r.baseLatency : "balanced" === o ? 512 / a : "interactive" === o || void 0 === o ? 256 / a : "playback" === o ? 1024 / a : 128 * Math.max(2, Math.min(128, Math.round(o * a / 128))) / a, this._nativeAudioContext = r, this._state = null, "running" === r.state) {
                this._state = "suspended";
                const t = () => {
    ...
    const r = (t, e, n, r, s, o) => class extends n {
        constructor(n, o) {
            ...
            Object.defineProperty(n, "sampleRate", {
                get: () => a
            }), r(n) && s.set(n, new Set), this._destination = new t(this, o), this._listener = e(this, n), this._onstatechange = null
        }
        get currentTime() {
        ...
        s = (t, e, n, s, o) => class extends s {
            constructor(e) {
                ...
                t(i.a, () => Object(i.a)(c)) || c.addEventListener("statechange", (() => {
                    ...
                    return e
                })()), super(c, o), this._length = s, this._nativeOfflineAudioContext = c, this._state = null
            }
            get length() {
            ...
            startRendering() {
                return "running" === this._state ? Promise.reject(e()) : (this._state = "running", o(this.destination, this._nativeOfflineAudioContext).then(t => (this._state = null, t)).catch(t => {
    ...
    const i = (t, e) => (n, i, r) => {
        const s = new Set;
        var o, a;
        return n.connect = (o = n.connect, (r, a = 0, c = 0) => {
            const u = 0 === s.size;
            if (e(r)) return o.call(n, r, a, c), t(s, [r, a, c], t => t[0] === r && t[1] === a && t[2] === c, !0), u && i(), r;
            o.call(n, r, a), t(s, [r, a], t => t[0] === r && t[1] === a, !0), u && i()
        }), n.disconnect = (a = n.disconnect, (t, i, o) => {
            const c = s.size > 0;
            if (void 0 === t) a.apply(n), s.clear();
            else if ("number" == typeof t) {
                a.call(n, t);
                for (const e of s) e[1] === t && s.delete(e)
            } else {
                e(t) ? a.call(n, t, i, o) : a.call(n, t, i);
                for (const e of s) e[0] !== t || void 0 !== i && e[1] !== i || void 0 !== o && e[2] !== o || s.delete(e)
            }
            const u = 0 === s.size;
            c && u && r()
        }), n
    ...
    const i = (t, e) => (n, i, r) => {
        ...
        if (s.channelCount !== i) try {
            s.channelCount = i
        } catch {}
        r && "explicit" !== s.channelCountMode && (s.channelCountMode = "explicit"), 0 === s.maxChannelCount && Object.defineProperty(s, "maxChannelCount", {
            value: i
        });
        const o = t(n, {
            channelCount: i,
        ...
        return e(o, "channelCount", t => () => t.call(o), t => e => {
            ...
            try {
                ...
                if (e > s.maxChannelCount) throw t
            }
        }), e(o, "channelCountMode", t => () => t.call(o), t => e => {
            t.call(o, e), s.channelCountMode = e
        }), e(o, "channelInterpretation", t => () => t.call(o), t => e => {
            t.call(o, e), s.channelInterpretation = e
    ...
    const o = t => (e, n) => {
        ...
        return Object(s.a)(o, n), Object(i.a)(o, n, "Q"), Object(i.a)(o, n, "detune"), Object(i.a)(o, n, "frequency"), Object(i.a)(o, n, "gain"), Object(r.a)(o, n, "type"), o
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const r = (t, e) => (n, r) => {
        ...
        return 1 !== s.channelCount && "explicit" !== s.channelCountMode && e(n, s), Object(i.a)(s, r), s
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const a = (t, e, n, a, c, u) => (h, l) => {
        ...
        return Object(r.a)(d, l), Object(i.a)(d, l, "offset"), e(c, () => c(h)) || Object(s.a)(d), e(u, () => u(h)) || Object(o.a)(d), t(h, d), d
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const r = (t, e, n, r) => (s, {
        ...
        return t(s, u), r(Object(i.a)(d, h), () => u.connect(h), () => u.disconnect(h))
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const s = (t, e, n) => (s, {
        ...
        h === p.normalize && (p.normalize = !h), o !== p.buffer && (p.buffer = o);
    ...
    const s = t => (e, n) => {
        ...
        return Object(r.a)(s, n), Object(i.a)(s, n, "delayTime"), s
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const s = (t, e) => (n, s) => {
        ...
        if (Object(r.a)(o, s), s.channelCount > 2) throw e();
        if ("max" === s.channelCountMode) throw e();
        return Object(i.a)(o, s, "attack"), Object(i.a)(o, s, "knee"), Object(i.a)(o, s, "ratio"), Object(i.a)(o, s, "release"), Object(i.a)(o, s, "threshold"), o
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const s = t => (e, n) => {
        ...
        return Object(r.a)(s, n), Object(i.a)(s, n, "gain"), s
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    var i = n(2);
    const r = (t, e) => (n, r, s) => {
        if (void 0 === n.createIIRFilter) return e(n, r, s);
        const o = t(n, t => t.createIIRFilter(s.feedforward, s.feedback));
        return Object(i.a)(o, s), o
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    function a(t, e) {
        let n = [0, 0];
        for (let s = t.length - 1; s >= 0; s -= 1) r = e, n = [(i = n)[0] * r[0] - i[1] * r[1], i[0] * r[1] + i[1] * r[0]], n[0] += t[s];
        var i, r;
        return n
    }
    const c = (t, e, n, c) => (u, h, {
    ...
    const r = (t, e) => (n, r) => {
        ...
        return Object(i.a)(s, r), 1 === s.numberOfOutputs && Object.defineProperty(s, "numberOfOutputs", {
            get: () => 0
        }), s
    }
}, function(t, e, n) {
    ...
    const c = (t, e, n, c, u, h, l) => (d, p) => {
        ...
        return Object(s.a)(f, p), Object(i.a)(f, p, "detune"), Object(i.a)(f, p, "frequency"), void 0 !== p.periodicWave ? f.setPeriodicWave(p.periodicWave) : Object(r.a)(f, p, "type"), e(c, () => c(d)) || Object(o.a)(f), e(u, () => u(d)) || l(f, d), e(h, () => h(d)) || Object(a.a)(f), t(d, f), f
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const o = (t, e) => (n, o) => {
        ...
        return void 0 === a.orientationX ? e(n, o) : (Object(s.a)(a, o), Object(i.a)(a, o, "orientationX"), Object(i.a)(a, o, "orientationY"), Object(i.a)(a, o, "orientationZ"), Object(i.a)(a, o, "positionX"), Object(i.a)(a, o, "positionY"), Object(i.a)(a, o, "positionZ"), Object(r.a)(a, o, "coneInnerAngle"), Object(r.a)(a, o, "coneOuterAngle"), Object(r.a)(a, o, "coneOuterGain"), Object(r.a)(a, o, "distanceModel"), Object(r.a)(a, o, "maxDistance"), Object(r.a)(a, o, "panningModel"), Object(r.a)(a, o, "refDistance"), Object(r.a)(a, o, "rolloffFactor"), a)
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
    ...
    const s = (t, e, n, s, o, a, c, u, h, l) => (d, {
        ...
        const q = {
            ...
            set channelCount(t) {
                if (t > 2) throw u();
                I.channelCount = t, O.channelCount = t
            },
            get channelCountMode() {
            ...
            set channelCountMode(t) {
                if ("max" === t) throw u();
                I.channelCountMode = t, O.channelCountMode = t
            },
            get channelInterpretation() {
                return O.channelInterpretation
            },
            set channelInterpretation(t) {
                I.channelInterpretation = t, O.channelInterpretation = t
            },
            get coneInnerAngle() {
        ...
        return l(Object(r.a)(q, O), () => {
            I.connect(O), t(I, U, 0, 0), U.connect(R).connect(A, 0, 0), U.connect(P).connect(A, 0, 1), U.connect(D).connect(A, 0, 2), U.connect(j).connect(A, 0, 3), U.connect(N).connect(A, 0, 4), U.connect(L).connect(A, 0, 5), A.connect(B).connect(d.destination)
        }, () => {
            I.disconnect(O), h(I, U, 0, 0), U.disconnect(R), R.disconnect(A), U.disconnect(P), P.disconnect(A), U.disconnect(D), D.disconnect(A), U.disconnect(j), j.disconnect(A), U.disconnect(N), N.disconnect(A), U.disconnect(L), L.disconnect(A), A.disconnect(B), B.disconnect(d.destination)
        })
    }
}, function(t, e, n) {
    "use strict";
    ...
    const s = (t, e, n) => (s, o) => t(s, t => {
        ...
        if (void 0 === s.createStereoPanner) return e(s, o);
        const c = t.createStereoPanner();
        return Object(r.a)(c, o), Object(i.a)(c, o, "pan"), Object.defineProperty(c, "channelCountMode", {
            get: () => a,
            set: t => {
                if (t !== a) throw n()
            }
    ...
    const r = (t, e, n, r, s, o) => {
        const a = new Float32Array([1, 1]),
            ...
            l = (t, i, o, l, d) => {
                if (1 === i) return ((t, e, i, s) => {
                    ...
                    return {
                        connectGraph() {
                            e.connect(d), e.connect(f.inputs[0]), e.connect(m), f.connect(i), i.connect(p.inputs[0]), i.connect(g.inputs[0]), p.connect(d.gain), g.connect(m.gain), d.connect(s, 0, 0), m.connect(s, 0, 1)
                        },
                        disconnectGraph() {
                            e.disconnect(d), e.disconnect(f.inputs[0]), e.disconnect(m), f.disconnect(i), i.disconnect(p.inputs[0]), i.disconnect(g.inputs[0]), p.disconnect(d.gain), g.disconnect(m.gain), d.disconnect(s, 0, 0), m.disconnect(s, 0, 1)
                        }
                    }
                })(t, o, l, d);
                if (2 === i) return ((t, i, s, o) => {
                    ...
                    return {
                        connectGraph() {
                            i.connect(g), i.connect(w.inputs[0]), g.connect(v, 1), g.connect(y, 1), g.connect(x, 1), g.connect(S, 1), w.connect(s), s.connect(b.inputs[0]), s.connect(_.inputs[0]), s.connect(T.inputs[0]), s.connect(C.inputs[0]), b.connect(v.gain), _.connect(y.gain), T.connect(x.gain), C.connect(S.gain), v.connect(o, 0, 0), x.connect(o, 0, 0), y.connect(o, 0, 1), S.connect(o, 0, 1)
                        },
                        disconnectGraph() {
                            i.disconnect(g), i.disconnect(w.inputs[0]), g.disconnect(v, 1), g.disconnect(y, 1), g.disconnect(x, 1), g.disconnect(S, 1), w.disconnect(s), s.disconnect(b.inputs[0]), s.disconnect(_.inputs[0]), s.disconnect(T.inputs[0]), s.disconnect(C.inputs[0]), b.disconnect(v.gain), _.disconnect(y.gain), T.disconnect(x.gain), C.disconnect(S.gain), v.disconnect(o, 0, 0), x.disconnect(o, 0, 0), y.disconnect(o, 0, 1), S.disconnect(o, 0, 1)
                        }
                    }
                })(t, o, l, d);
                throw s()
        ...
        return (e, {
            ...
            const g = {
                ...
                set channelCountMode(t) {
                    if ("clamped-max" === t || "max" === t) throw s();
    ...
    const s = (t, e, n, s, o, a, c) => (u, h) => {
        ...
        try {
            return l.curve = new Float32Array([1]), s(u, h)
        } catch {}
        Object(r.a)(l, h);
        const d = h.curve;
        ...
        let p = null,
            f = !1;
        c(l, "curve", t => () => t.call(l), e => n => (e.call(l, n), f && (o(n) && null === p ? p = t(u, l) : o(n) || null === p || (p(), p = null)), n));
        return a(l, () => {
            f = !0, o(l.curve) && (p = t(u, l))
        }, () => {
            f = !1, null !== p && (p(), p = null)
        })
    }
    ...
    const s = (t, e, n, s, o, a) => (c, {
                ...
                if (null === n) d.curve = n, p.curve = n;
                    ...
                    for (let o = 1; o < r; o += 1) {
                        const a = o / r * s,
                            c = Math.floor(a),
                            u = Math.ceil(a);
                        e[o] = c === u ? n[c] : (1 - (a - c)) * n[c] + (1 - (u - a)) * n[u], i[o] = c === u ? -n[t - 1 - c] : -(1 - (a - c)) * n[t - 1 - c] - (1 - (u - a)) * n[t - 1 - u]
                    }
                    e[r] = t % 2 == 1 ? n[r - 1] : (n[r - 2] + n[r - 1]) / 2, d.curve = e, p.curve = i
                }
                _ = n, y && (o(_) && null === b ? b = t(c, f) : null !== b && (b(), b = null))
            },
            get inputs() {
                return [f]
            },
        ...
        return a(Object(r.a)(w, g), () => {
            f.connect(d).connect(g), f.connect(m).connect(p).connect(v).connect(g), y = !0, o(_) && (b = t(c, f))
        }, () => {
    ...
    const r = {
        ...
        s = (t, e, n, s, o) => class extends t {
            constructor(t, n, o) {
                let a;
                if ("number" == typeof t && void 0 !== n && void 0 !== o) a = {
                    length: n,
                    numberOfChannels: t,
                    sampleRate: o
                };
            ...
            startRendering() {
                return "running" === this._state ? Promise.reject(n()) : (this._state = "running", o(this.destination, this._nativeOfflineAudioContext).then(t => (this._state = null, t)).catch(t => {
                    throw this._state = null, t
                }))
            }
            _waitForThePromiseToSettle(t) {
        ...
        return {
            ...
            render(h, l, d) {
                ...
                return void 0 !== p ? Promise.resolve(p) : (async (h, l, d) => {
                    ...
                    return o.set(l, p), f ? (await t(l, h.detune, p.detune, d), await t(l, h.frequency, p.frequency, d)) : (await r(l, h.detune, p.detune, d), await r(l, h.frequency, p.frequency, d)), await s(h, l, p, d), p
                })(h, l, d)
            }
        }
    }
        ...
        s = (t, e, n, s, o, a) => class extends t {
            constructor(t, c = r) {
                const u = o(t),
                    ...
                    l = n(u, h),
                    d = a(u);
                super(t, !1, l, d ? s() : null), this._nativePannerNode = l, this._orientationX = e(this, d, l.orientationX, i.b, i.a), this._orientationY = e(this, d, l.orientationY, i.b, i.a), this._orientationZ = e(this, d, l.orientationZ, i.b, i.a), this._positionX = e(this, d, l.positionX, i.b, i.a), this._positionY = e(this, d, l.positionY, i.b, i.a), this._positionZ = e(this, d, l.positionZ, i.b, i.a)
            }
            get coneInnerAngle() {
                    ...
                    if (d.set(m, null === v ? b : v), null !== v) {
                        ...
                        for (let e = 128; e < t.length; e += 128) {
                            ...
                            if (t.some((t, e) => t !== a[e]) || n.some((t, e) => t !== d[e])) {
                                ...
                                b.gain.setValueAtTime(0, r), b = s(m, { ...y,
                                    gain: 0
                                }), w = o(m, { ..._,
                                    orientationX: a[0],
                                    orientationY: a[1],
    ...
    const i = (t, e) => (n, i, r, s) => (t(i).replay(r), e(i, n, r, s))
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
        return i
    ...
    const r = (t, e, n, r) => s => t(i.a, () => Object(i.a)(s)) ? Promise.resolve(t(r, r)).then(t => {
        if (!t) {
            ...
            }, t.onaudioprocess = () => s.currentTime, t.connect(s.destination)
        }
    ...
    const r = (t, e, n, r, s, o, a, c) => {
        const u = [];
        return (h, l) => n(h).render(h, l, u).then(() => Promise.all(Array.from(r(l)).map(t => n(t).render(t, l, u)))).then(() => s(l)).then(n => ("function" != typeof n.copyFromChannel ? (a(n), Object(i.a)(n)) : e(o, () => o(n)) || c(n), t.add(n), n))
    }
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", (function() {
        ...
        return {
            render(c, u, h) {
                ...
                return void 0 !== l ? Promise.resolve(l) : (async (c, u, h) => {
                    ...
                    return a.set(u, l), d ? await t(u, c.pan, l.pan, h) : await s(u, c.pan, l.pan, h), Object(i.a)(l) ? await o(c, u, l.inputs[0], h) : await o(c, u, l, h), l
                })(c, u, h)
            }
        }
    }
    ...
    const i = (t, e) => async () => {
        ...
        try {
            ...
            n.port.onmessage = () => s = !0, e.connect(n), await i.startRendering()
        } catch {} finally {
        ...
        r = (t, e, n, r, s, o) => class extends t {
            constructor(t, e = i) {
                const a = s(t),
                    ...
                    u = n(a, c);
                super(t, !0, u, o(a) ? r() : null), this._isCurveNullified = !1, this._nativeWaveShaperNode = u
            }
            get curve() {
    ...
    const i = (t, e) => n => {
        n.copyFromChannel = (i, r, s = 0) => {
            ...
            const c = n.length,
                ...
                h = i.length;
            for (let t = o < 0 ? -o : 0; t + o < c && t < h; t += 1) i[t] = u[t + o]
            ...
            const c = n.length,
                u = n.getChannelData(a),
                h = i.length;
            for (let t = o < 0 ? -o : 0; t + o < c && t < h; t += 1) u[t + o] = i[t]
        }
    }
}, function(t, e, n) {
    "use strict";
    ...
    const i = t => e => {
        var n, i;
        e.copyFromChannel = (n = e.copyFromChannel, (i, r, s = 0) => {
            const o = t(s),
                a = t(r);
            if (o < e.length) return n.call(e, i, a, o)
        }), e.copyToChannel = (i = e.copyToChannel, (n, r, s = 0) => {
            const o = t(s),
                a = t(r);
            if (o < e.length) return i.call(e, n, a, o)
        })
    }
}, function(t, e, n) {
    "use strict";
    ...
    const r = t => (e, n) => {
        ...
        const s = (o = e.disconnect, () => {
            o.call(e, r), e.removeEventListener("ended", s)
        });
        var o;
        e.addEventListener("ended", s), Object(i.a)(e, r), e.stop = (t => {
            let n = !1;
            return (i = 0) => {
                if (n) try {
                    t.call(e, i)
    ...
    const i = (t, e, n) => (i, r) => {
        ...
        n(r, () => {
            ...
            for (let e = 0; e < t; e += 1) s.connect(r, 0, e)
        }, () => s.disconnect(r))
    }
}, function(t, e, n) {
    "use strict";
    ...
    t.exports = function(t, e) {
        ...
        return function(t, e, i, r, s) {
            var o = s / 8,
                ...
                u = new DataView(c);
            n(u, 0, "RIFF"), u.setUint32(4, 36 + t.length * o, !0), n(u, 8, "WAVE"), n(u, 12, "fmt "), u.setUint32(16, 16, !0), u.setUint16(20, e, !0), u.setUint16(22, r, !0), u.setUint32(24, i, !0), u.setUint32(28, i * a, !0), u.setUint16(32, a, !0), u.setUint16(34, s, !0), n(u, 36, "data"), u.setUint32(40, t.length * o, !0), 1 === e ? function(t, e, n) {
    ...
    ! function() {
        ...
        function u(t) {
            ...
            e = "function" == typeof t ? t : t ? function() {
                var t = 0,
                    ...
                    r = l();
                t = r(" "), e = r(" "), n = r(" ");
                for (var s = 0; s < arguments.length; s++)(t -= r(arguments[s])) < 0 && (t += 1), (e -= r(arguments[s])) < 0 && (e += 1), (n -= r(arguments[s])) < 0 && (n += 1);
                return r = null,
                    function() {
        ...
        u.prototype = {
            ...
            noise3D: function(t, e, n) {
                var i, r, s, a, c, u, h, l, d, p, f = this.permMod12,
                    m = this.perm,
                    g = this.grad3,
                    v = (t + e + n) * (1 / 3),
                    b = Math.floor(t + v),
            ...
            noise4D: function(t, e, n, i) {
                var r, s, o, u, h, l, d, p, f, m, g, v, b, y, _, w, x, T = this.perm,
                    S = this.grad4,
                    C = (t + e + n + i) * a,
                    k = Math.floor(t + C),
                    E = Math.floor(e + C),
                    ...
                    L = 0,
                    B = 0;
                I > R ? j++ : N++, I > P ? j++ : L++, I > D ? j++ : B++, R > P ? N++ : L++, R > D ? N++ : B++, P > D ? L++ : B++;
                var U = I - (l = j >= 3 ? 1 : 0) + c,
                    F = R - (d = N >= 3 ? 1 : 0) + c,
                    V = P - (p = L >= 3 ? 1 : 0) + c,
                    q = D - (f = B >= 3 ? 1 : 0) + c,
    ...
    const T = (t, e) => {
        ...
        S = t => new Promise(e => {
            ...
            o.buffer = r, o.loop = !0, o.connect(n).connect(t.destination), o.connect(i), o.disconnect(i), n.onaudioprocess = i => {
                const r = i.inputBuffer.getChannelData(0);
                Array.prototype.some.call(r, t => 1 === t) ? e(!0) : e(!1), o.stop(), n.onaudioprocess = null, o.disconnect(n), n.disconnect(t.destination)
            }, o.start()
        }),
        C = (t, e) => {
            const n = new Map;
    ...
    const E = (t, e, [n, i, r], s) => {
        ...
        M = (t, e, [n, i, r], s) => {
            const o = t.get(n);
            void 0 === o ? t.set(n, new Set([
                [i, e, r]
            ])) : Object(g.a)(o, [i, e, r], t => t[0] === i && t[1] === e, s)
        },
        A = (t, [e, n, i], r) => {
            const s = t.get(e);
            void 0 === s ? t.set(e, new Set([
                [n, i]
            ])) : Object(g.a)(s, [n, i], t => t[0] === n, r)
        },
        I = (t, e, n, i) => {
            const r = Object(m.a)(t, e),
                s = _(r, t => t[0] === n && t[1] === i);
            return 0 === r.size && t.delete(e), s
        },
        R = (t, e, n) => {
        ...
        P = (t, e, n, i) => {
            const {
                ...
                outputs: o
            } = Object(l.a)(t), u = Object(c.a)(t), d = o => {
                const c = Object(p.a)(e),
                    u = Object(p.a)(t);
                if (o) {
                    const o = I(s, t, n, i);
                    E(r, t, o, !1), Object(b.a)(t) || Object(a.a)(u, c, n, i), y(e) && Object(w.a)(e)
                } else {
                    const o = ((t, e, n, i) => _(t[i], t => t[0] === e && t[1] === n))(r, t, n, i);
                    M(s, i, o, !1), Object(b.a)(t) || Object(h.a)(u, c, n, i), Object(v.a)(e) && T(e, r)
                }
            };
            return !!Object(g.a)(o, [e, n, i], t => t[0] === e && t[1] === n && t[2] === i, !0) && (u.add(d), Object(v.a)(t) ? E(r, t, [n, i, d], !0) : M(s, i, [t, n, d], !0), !0)
        },
        D = (t, e, n) => {
            const {
                activeInputs: i,
                ...
                outputs: s
            } = Object(l.a)(t), o = Object(c.a)(t), a = s => {
                const o = Object(p.a)(t),
                    a = Object(f.a)(e);
                if (s) {
                    const e = R(r, t, n);
                    O(i, t, e, !1), Object(b.a)(t) || o.connect(a, n)
                } else {
                    const e = ((t, e, n) => _(t, t => t[0] === e && t[1] === n))(i, t, n);
                    A(r, e, !1), Object(b.a)(t) || o.disconnect(a, n)
                }
            };
            return !!Object(g.a)(s, [e, n], t => t[0] === e && t[1] === n, !0) && (o.add(a), Object(v.a)(t) ? O(i, t, [n, a], !0) : A(r, [t, n, a], !0), !0)
        },
        j = (t, e, n) => {
            for (const i of t)
        ...
        N = (t, e, n, i) => {
            const [r, s] = ((t, e, n, i) => {
                const {
                    activeInputs: r,
                    passiveInputs: s
                } = Object(l.a)(e), o = j(r[i], t, n);
                if (null === o) {
                    return [I(s, t, n, i)[2], !1]
                }
                return [o[2], !0]
            })(t, e, n, i);
            if (null !== r && (u(t, r), s && !Object(b.a)(t) && Object(h.a)(Object(p.a)(t), Object(p.a)(e), n, i)), Object(v.a)(e)) {
                const {
                    activeInputs: t
                } = Object(l.a)(e);
                T(e, t)
        ...
        B = (t, e, n, c, u, h, m, v, b, _, x, T, M, A, I) => class extends _ {
            constructor(e, r, s, o) {
                super(s), this._context = e, this._nativeAudioNode = s;
                const a = x(e);
                T(a) && !0 !== n(S, () => S(a)) && (t => {
                    const e = new Map;
                    var n, i;
                    ...
                    }), t.disconnect = (i = t.disconnect, (n, r, s) => {
                ...
                })(s), i.c.set(this, s), i.i.set(this, new Set), r && Object(w.a)(this), t(this, o, s)
            }
            get channelCount() {
            ...
            connect(t, n = 0, i = 0) {
                ...
                if (Object(r.a)(t)) {
                    ...
                    try {
                        ...
                        if (v || y(this) ? this._nativeAudioNode.disconnect(...c) : y(t) && Object(w.a)(t), o(t)) {
                            const t = e.get(r);
                            if (void 0 === t) {
            ...
            disconnect(t, e, n) {
                ...
                if (void 0 === t) i = (t => {
                    const e = Object(l.a)(t),
                        n = [];
                    for (const i of e.outputs) Object(s.a)(i) ? N(t, ...i) : L(t, ...i), n.push(i[0]);
                    ...
                    i = ((t, e) => {
                        const n = Object(l.a)(t),
                            i = [];
                        for (const r of n.outputs) r[1] === e && (Object(s.a)(r) ? N(t, ...r) : L(t, ...r), i.push(r[0]), n.outputs.delete(r));
                        return i
                    })(this, t)
                } else {
                    ...
                    if (i = ((t, e, n, i) => {
                            ...
                            return Array.from(r.outputs).filter(t => !(t[0] !== e || void 0 !== n && t[1] !== n || void 0 !== i && t[2] !== i)).map(e => (Object(s.a)(e) ? N(t, ...e) : L(t, ...e), r.outputs.delete(e), e[0]))
    ...
    const l = (t, e, n, l, d, p, f, m, g, v, b, y, _) => (w, x, T, S) => {
        ...
        for (let t = 0; t < S.numberOfInputs; t += 1) {
            M[t].connect(A[t]);
            for (let e = 0; e < S.channelCount; e += 1) A[t].connect(R, e, t * S.channelCount + e)
        }
        ...
        D.onaudioprocess = ({
            ...
            if (null !== W)
                for (let i = 0; i < P; i += 128) {
                    for (let t = 0; t < S.numberOfInputs; t += 1)
                        for (let n = 0; n < S.channelCount; n += 1) Object(s.a)(e, Y[t], n, n, i);
                    ...
                    try {
                        ...
                        J = r;
                        for (let t = 0, e = 0; t < S.numberOfOutputs; t += 1) {
                            for (let r = 0; r < S.outputChannelCount[t]; r += 1) Object(o.a)(n, X[t], r, e + r, i);
                            e += S.outputChannelCount[t]
                        }
                    } catch (t) {
                    ...
                    if (!J) {
                        for (let t = 0; t < S.numberOfInputs; t += 1) {
                            M[t].disconnect(A[t]);
                            for (let e = 0; e < S.channelCount; e += 1) A[i].disconnect(R, e, t * S.channelCount + e)
                        }
                        if (void 0 !== T.parameterDescriptors) {
    ...
    const r = {
        ...
        o = (t, e) => {
            ...
            for (; null !== r;) {
                ...
                n.push(o), i = i.slice(r[0].length).replace(/^[\s]+/, ""), r = i.match(s)
            }
            return [n.join(";"), i]
        },
        a = t => {
    ...
    const s = t => "function" == typeof t.getFloatTimeDomainData,
        o = (t, e, n) => (o, a) => {
            ...
            return Object(i.a)(c, a, "fftSize"), Object(i.a)(c, a, "maxDecibels"), Object(i.a)(c, a, "minDecibels"), Object(i.a)(c, a, "smoothingTimeConstant"), t(s, () => s(c)) || (t => {
    ...
    const u = (t, e, n, u, h, l, d, p, f, m, g, v, b) => (y, _ = {}) => {
        ...
        return Object(s.a)(w, _), Object(i.a)(w, _, "playbackRate"), Object(r.a)(w, _, "buffer"), Object(r.a)(w, _, "loop"), Object(r.a)(w, _, "loopEnd"), Object(r.a)(w, _, "loopStart"), e(u, () => u(y)) || (t => {
            t.start = (e => {
                let n = !1;
                return (i = 0, r = 0, s) => {
                    if (n) throw Object(o.a)();
                    e.call(t, i, r, s), n = !0
                }
            })(t.start)
        })(w), e(h, h) || ((t, e) => {
            ...
            var r, s;
            t.start = (r = t.start, s = t.stop, (o = 0, a = 0, c = Number.POSITIVE_INFINITY) => {
                if (r.call(t, o, a), c >= 0 && c < Number.POSITIVE_INFINITY) {
                    const r = Math.max(o, e.currentTime),
                        a = c / t.playbackRate.value;
                    n = r + a, s.call(t, Math.min(n, i))
                }
            }), t.stop = (r => (s = 0) => {
                i = Math.max(s, e.currentTime), r.call(t, Math.min(n, i))
            })(t.stop)
    ...
    const l = async (t, e, n, h, l, d) => {
            ...
            const v = Object(o.a)(t),
                ...
                w = Array.from(t.parameters.keys()).reduce((t, e) => ({ ...t,
                    [e]: new Float32Array(128)
                }), {});
            for (let s = 0; s < p; s += 128) {
                if (h.numberOfInputs > 0 && null !== e)
                    for (let t = 0; t < h.numberOfInputs; t += 1)
                        for (let n = 0; n < h.channelCount; n += 1) Object(i.a)(e, y[t], n, n, s);
                ...
                try {
                    ...
                    if (null !== g)
                        for (let t = 0, e = 0; t < h.numberOfOutputs; t += 1) {
                            for (let n = 0; n < h.outputChannelCount[t]; n += 1) Object(r.a)(g, _[t], n, e + n, s);
                    ...
                    return void 0 !== k ? Promise.resolve(k) : (async (a, T, S) => {
                        ...
                        if (null === p) {
                            const t = y.outputChannelCount.reduce((t, e) => t + e, 0),
                                ...
                                s = [];
                            for (let t = 0; t < a.numberOfOutputs; t += 1) s.push(i(T, {
                                channelCount: 1,
                                channelCountMode: "explicit",
                                channelInterpretation: "speakers",
                            ...
                            u.connect = e.bind(null, s), u.disconnect = c.bind(null, s), k = [n, s, u]
                        } else E || (C = new p(T, b));
                                ...
                                const t = a.channelCount * a.numberOfInputs,
                                    ...
                                    c = async () => {
                                        const c = new f(n, 128 * Math.ceil(a.context.length / 128), T.sampleRate),
                                            u = [],
                                            h = [];
                                        for (let t = 0; t < y.numberOfInputs; t += 1) u.push(o(c, {
                                            channelCount: y.channelCount,
                                            channelCountMode: y.channelCountMode,
                                            channelInterpretation: y.channelInterpretation,
                                            gain: 1
        ...
        return new Promise((e, n) => {
            ...
            try {
                g.decodeAudioData(m, n => {
                    "function" != typeof n.copyFromChannel && (d(n), Object(i.a)(n)), t.add(n), s(), e(n)
                }, t => {
                    o(null === t ? r() : t)
                })
            } catch (t) {
        ...
        s = (t, e, n, s, o) => class extends t {
            constructor(t, a) {
                ...
                super(t, !1, l, u ? n(h.feedback, h.feedforward) : null), (t => {
                    var e;
                    t.getFrequencyResponse = (e = t.getFrequencyResponse, (n, r, s) => {
                        if (n.length !== r.length || r.length !== s.length) throw Object(i.a)();
    ...
    const i = (t, e, n, i, r, s) => (o, a, c, u, h, l) => {
        if (null !== c) try {
            ...
            if (Object.defineProperties(n, {
                ...
                return n.connect(t).connect(t.context.destination), s(n, () => t.disconnect(), () => t.connect(t.context.destination))
            }
            return n
        } catch (t) {
    ...
    function n(t) {
        ...
        function o() {
            ...
            if (240 == (240 & i)) {
                ...
                switch (r) {
                    case 0:
                        if (t.type = "sequenceNumber", 2 !== s) throw "Expected length for sequenceNumber event is 2, got " + s;
                        return t.number = n.readUInt16(), t;
                    case 1:
                        return t.type = "text", t.text = n.readString(s), t;
                    case 2:
                        return t.type = "copyrightNotice", t.text = n.readString(s), t;
                    case 3:
                        return t.type = "trackName", t.text = n.readString(s), t;
                    case 4:
                        return t.type = "instrumentName", t.text = n.readString(s), t;
                    case 5:
                        return t.type = "lyrics", t.text = n.readString(s), t;
                    case 6:
                        return t.type = "marker", t.text = n.readString(s), t;
                    case 7:
                        return t.type = "cuePoint", t.text = n.readString(s), t;
                    case 32:
                        if (t.type = "channelPrefix", 1 != s) throw "Expected length for channelPrefix event is 1, got " + s;
                        return t.channel = n.readUInt8(), t;
                    case 33:
                        if (t.type = "portPrefix", 1 != s) throw "Expected length for portPrefix event is 1, got " + s;
                        return t.port = n.readUInt8(), t;
                    case 47:
                        if (t.type = "endOfTrack", 0 != s) throw "Expected length for endOfTrack event is 0, got " + s;
                        return t;
                    case 81:
                        if (t.type = "setTempo", 3 != s) throw "Expected length for setTempo event is 3, got " + s;
                        return t.microsecondsPerBeat = n.readUInt24(), t;
                    case 84:
                        if (t.type = "smpteOffset", 5 != s) throw "Expected length for smpteOffset event is 5, got " + s;
                        var o = n.readUInt8();
                        return t.frameRate = {
                            0: 24,
                            32: 25,
                    ...
                    case 88:
                        if (t.type = "timeSignature", 4 != s) throw "Expected length for timeSignature event is 4, got " + s;
                        return t.numerator = n.readUInt8(), t.denominator = 1 << n.readUInt8(), t.metronome = n.readUInt8(), t.thirtyseconds = n.readUInt8(), t;
                    case 89:
                        if (t.type = "keySignature", 2 != s) throw "Expected length for keySignature event is 2, got " + s;
                        return t.key = n.readInt8(), t.scale = n.readUInt8(), t;
                    case 127:
                        return t.type = "sequencerSpecific", t.data = n.readBytes(s), t;
                    default:
                        return t.type = "unknownMeta", t.data = n.readBytes(s), t.metatypeByte = r, t
                }
            } else {
                var a;
                if (0 == (128 & i)) {
    ...
    i.prototype.eof = function() {
        ...
        for (var s = function(t) {
                var e = new i(t),
                    ...
                    o = e.readUInt16();
                32768 & o ? (s.framesPerSecond = 256 - (o >> 8), s.ticksPerFrame = 255 & o) : s.ticksPerBeat = o;
                return s
    ...
    function n(t, e, n) {
        var s, o = new r,
            a = e.length,
            c = null;
        for (s = 0; s < a; s++) !1 !== n.running && (n.running || e[s].running) || (c = null), c = i(o, e[s], c, n.useByte9ForNoteOff);
        ...
        switch (r(t)) {
            ...
            case "array":
                return function(t, e) {
                    ...
                    for (let i = 0; i < t.length; i++) n[i] = o(t[i], e);
                    return n
                }(t, e);
            default:
                return i(t)
            ...
            for (var i = [], r = e; r < n;) {
                ...
                if (r + l <= n) switch (l) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        s = t[r + 1], o = t[r + 2], 128 == (192 & s) && 128 == (192 & o) && (c = (15 & u) << 12 | (63 & s) << 6 | 63 & o) > 2047 && (c < 55296 || c > 57343) && (h = c);
                        break;
                    case 4:
                        s = t[r + 1], o = t[r + 2], a = t[r + 3], 128 == (192 & s) && 128 == (192 & o) && 128 == (192 & a) && (c = (15 & u) << 18 | (63 & s) << 12 | (63 & o) << 6 | 63 & a) > 65535 && c < 1114112 && (h = c)
                }
    ...
    e.byteLength = function(t) {
        ...
        var e, n, i = u(t),
            ...
            h = 0,
            l = a > 0 ? o - 4 : o;
        for (n = 0; n < l; n += 4) e = r[t.charCodeAt(n)] << 18 | r[t.charCodeAt(n + 1)] << 12 | r[t.charCodeAt(n + 2)] << 6 | r[t.charCodeAt(n + 3)], c[h++] = e >> 16 & 255, c[h++] = e >> 8 & 255, c[h++] = 255 & e;
        ...
        for (var e, n = t.length, r = n % 3, s = [], o = 0, a = n - r; o < a; o += 16383) s.push(h(t, o, o + 16383 > a ? a : o + 16383));
        1 === r ? (e = t[n - 1], s.push(i[e >> 2] + i[e << 4 & 63] + "==")) : 2 === r && (e = (t[n - 2] << 8) + t[n - 1], s.push(i[e >> 10] + i[e >> 4 & 63] + i[e << 2 & 63] + "="));
        return s.join("")
    };
    for (var i = [], r = [], s = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0, c = o.length; a < c; ++a) i[a] = o[a], r[o.charCodeAt(a)] = a;
    ...
    function h(t, e, n) {
        for (var r, s, o = [], a = e; a < n; a += 3) r = (t[a] << 16 & 16711680) + (t[a + 1] << 8 & 65280) + (255 & t[a + 2]), o.push(i[(s = r) >> 18 & 63] + i[s >> 12 & 63] + i[s >> 6 & 63] + i[63 & s]);
        return o.join("")
    }
    ...
    e.read = function(t, e, n, i, r) {
        var s, o, a = 8 * r - i - 1,
            ...
            d = n ? -1 : 1,
            p = t[e + l];
        for (l += d, s = p & (1 << -h) - 1, p >>= -h, h += a; h > 0; s = 256 * s + t[e + l], l += d, h -= 8);
        for (o = s & (1 << -h) - 1, s >>= -h, h += i; h > 0; o = 256 * o + t[e + l], l += d, h -= 8);
        if (0 === s) s = 1 - u;
        else {
        ...
        var o, a, c, u = 8 * s - r - 1,
            ...
            f = i ? 1 : -1,
            m = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0, o = h) : (o = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), (e += o + l >= 1 ? d / c : d * Math.pow(2, 1 - l)) * c >= 2 && (o++, c /= 2), o + l >= h ? (a = 0, o = h) : o + l >= 1 ? (a = (e * c - 1) * Math.pow(2, r), o += l) : (a = e * Math.pow(2, l - 1) * Math.pow(2, r), o = 0)); r >= 8; t[n + p] = 255 & a, p += f, a /= 256, r -= 8);
        for (o = o << r | a, u += r; u > 0; t[n + p] = 255 & o, p += f, o /= 256, u -= 8);
        t[n + p - f] |= 128 * m
    }
}, function(t, e) {
    var n = {}.toString;
    ...
    t.exports = function() {
        ...
        return function(t) {
            ...
            for (m = c; m < a; m++) o[m] < u && (u = o[m]), o[m] > h && (h = o[m]);
            var w = Math.round(r * (h - u) + u);
            for (m = c; m <= a && o[m] > w; m++);
            var x = c / 2;
            u = o[m];
            var T = m;
            for (f = m - 1; f < m + x && f <= a; f++) o[f] < u && (u = o[f], T = f);
    ...
    t.exports = function() {
        ...
        return function(t) {
            ...
            for (var s = (r /= 2) / 2, o = new Float32Array(s), a = void 0, c = void 0, u = 0; u < s; u++) o[u] = 0;
            for (var h = 1; h < s; h++)
                for (var l = 0; l < s; l++) {
                    var d = t[l] - t[l + h];
                    o[h] += d * d
            ...
            o[0] = 1, o[1] = 1;
            for (var p = 0, f = 1; f < s; f++) p += o[f], o[f] *= f / p;
            for (c = 2; c < s; c++)
                if (o[c] < e) {
                    for (; c + 1 < s && o[c + 1] < o[c];) c++;
                    a = 1 - o[c];
                    break
                }
            if (c == s || o[c] >= e) return null;
            if (a < i) return null;
            var m = void 0,
                g = void 0,
                v = void 0;
            if (v = c + 1 < s ? c + 1 : c, (g = c < 1 ? c : c - 1) === c) m = o[c] <= o[v] ? c : v;
            else if (v === c) m = o[c] <= o[g] ? c : g;
            else {
                var b = o[g],
                    y = o[c],
                    _ = o[v];
    ...
    t.exports = function() {
        ...
        return function(t) {
            for (var n = [], i = [], r = t.length, s = null, o = 0, a = 0, c = 0, u = 0; u < r; u++) {
                var h = t[u];
                o += h, c = Math.max(c, h), a = Math.min(a, h)
            }
            for (var l = .75 * ((c -= o /= r) > -1 * (a -= o) ? c : -1 * a), d = 0, p = -1, f = t.length, m = void 0, g = void 0, v = void 0; m = ~~(e / (3e3 * Math.pow(2, d))), !(f < 2);) {
                var b = void 0,
                    y = -1e3,
                    _ = -1e6,
                    w = -1e6,
                ...
                for (var M = 0; M < v; M++)
                    for (var A = 1; A < 3; A++) M + A < v && (E[Math.abs(n[M] - n[M + A])] += 1);
                for (var I = -1, R = -1, P = 0; P < f; P++) {
                    for (var D = 0, j = -1 * m; j <= m; j++) P + j >= 0 && P + j < f && (D += E[P + j]);
                    D === R ? P === 2 * I && (I = P) : D > R && (R = D, I = P)
                }
    ...
    t.exports = function(t) {
        ...
        return function(t) {
            ...
            a = [], c = [], u = [],
                function(t) {
                    for (var e = 0; e < t.length; e++) {
                        for (var n = 0, i = 0, s = 0; s < t.length - e; s++) n += t[s] * t[s + e], i += t[s] * t[s] + t[s + e] * t[s + e];
                        r[e] = 2 * n / i
                    }
                }(t),
                function() {
            ...
            for (var d = -1 / 0, p = 0; p < a.length; p++) {
                var f = a[p];
                d = Math.max(d, r[f]), r[f] > .5 && (l(f), u.push(o), c.push(s), d = Math.max(d, o))
            }
            if (c.length) {
    ...
    t.exports = function(t, e) {
        ...
        for (var o in e) hasOwnProperty.call(e, o) && (s[o] = e[o]);
        var a = i.log,
            c = i.detectBrowser(r),
            u = {
                browserDetails: c,
        ...
        switch (c.browser) {
            case "chrome":
                if (!h || !h.shimPeerConnection || !s.shimChrome) return a("Chrome shim is not included in this adapter release."), u;
                a("adapter.js shimming chrome."), u.browserShim = h, f.shimCreateObjectURL(r), h.shimGetUserMedia(r), h.shimMediaStream(r), h.shimSourceObject(r), h.shimPeerConnection(r), h.shimOnTrack(r), h.shimAddTrackRemoveTrack(r), h.shimGetSendersWithDtmf(r), f.shimRTCIceCandidate(r);
                break;
            case "firefox":
                if (!d || !d.shimPeerConnection || !s.shimFirefox) return a("Firefox shim is not included in this adapter release."), u;
                a("adapter.js shimming firefox."), u.browserShim = d, f.shimCreateObjectURL(r), d.shimGetUserMedia(r), d.shimSourceObject(r), d.shimPeerConnection(r), d.shimOnTrack(r), d.shimRemoveStream(r), f.shimRTCIceCandidate(r);
                break;
            case "edge":
                if (!l || !l.shimPeerConnection || !s.shimEdge) return a("MS edge shim is not included in this adapter release."), u;
                a("adapter.js shimming edge."), u.browserShim = l, f.shimCreateObjectURL(r), l.shimGetUserMedia(r), l.shimPeerConnection(r), l.shimReplaceTrack(r);
                break;
            case "safari":
                if (!p || !s.shimSafari) return a("Safari shim is not included in this adapter release."), u;
                a("adapter.js shimming safari."), u.browserShim = p, f.shimCreateObjectURL(r), p.shimRTCIceServerUrls(r), p.shimCallbacksAPI(r), p.shimLocalStreamsAPI(r), p.shimRemoteStreamsAPI(r), p.shimTrackEventTransceiver(r), p.shimGetUserMedia(r), p.shimCreateOfferLegacy(r), f.shimRTCIceCandidate(r);
                break;
            default:
        ...
        s = {
                        ...
                        return n._ontrackpoly || (n._ontrackpoly = function(e) {
                            e.stream.addEventListener("addtrack", (function(i) {
                                ...
                                s.track = i.track, s.receiver = r, s.transceiver = {
                                    receiver: r
                                }, s.streams = [e.stream], n.dispatchEvent(s)
                ...
                if ("object" == typeof t && t.RTCPeerConnection && !("getSenders" in t.RTCPeerConnection.prototype) && "createDTMFSender" in t.RTCPeerConnection.prototype) {
                    ...
                    if (!t.RTCPeerConnection.prototype.getSenders) {
                        ...
                        t.RTCPeerConnection.prototype.addTrack = function(t, i) {
                            ...
                            return s || (s = e(r, t), r._senders.push(s)), s
                        };
                    ...
                    t.RTCPeerConnection.prototype.removeStream = function(t) {
                        var e = this;
                        e._senders = e._senders || [], s.apply(e, [t]), t.getTracks().forEach((function(t) {
            ...
            shimAddTrackRemoveTrack: function(t) {
                ...
                if (!(t.RTCPeerConnection.prototype.addTrack && e.version >= 64)) {
                    ...
                    t.RTCPeerConnection.prototype.removeStream = function(t) {
                        var e = this;
                        e._streams = e._streams || {}, e._reverseStreams = e._reverseStreams || {}, s.apply(e, [e._streams[t.id] || t]), delete e._reverseStreams[e._streams[t.id] ? e._streams[t.id].id : t.id], delete e._streams[t.id]
                    ...
                    t.RTCPeerConnection.prototype.setLocalDescription = function() {
                        var t = this;
                        return arguments.length && arguments[0].type ? (arguments[0] = u(t, arguments[0]), o.apply(t, arguments)) : o.apply(t, arguments)
                    };
            ...
            shimPeerConnection: function(t) {
                    ...
                    t.RTCPeerConnection = function(t, e) {
                        if (t && t.iceServers) {
                            for (var r = [], s = 0; s < t.iceServers.length; s++) {
                                ...
                                !o.hasOwnProperty("urls") && o.hasOwnProperty("url") ? (i.deprecated("RTCIceServer.url", "RTCIceServer.urls"), (o = JSON.parse(JSON.stringify(o))).urls = o.url, r.push(o)) : r.push(t.iceServers[s])
                            }
                            t.iceServers = r
                        }
                        return new n(t, e)
                ...
                } else t.RTCPeerConnection = function(e, n) {
                ...
                return Object.keys(t).forEach((function(n) {
                    if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
                        ...
                        if (void 0 !== i.ideal) {
                            ...
                            var s = {};
                            "number" == typeof i.ideal ? (s[r("min", n)] = i.ideal, e.optional.push(s), (s = {})[r("max", n)] = i.ideal, e.optional.push(s)) : (s[r("", n)] = i.ideal, e.optional.push(s))
                        }
                    ...
                    if (a && ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) && (!n.mediaDevices.getSupportedConstraints || !n.mediaDevices.getSupportedConstraints().facingMode || u))
                        if (delete t.video.facingMode, "environment" === a.exact || "environment" === a.ideal ? c = ["back", "rear"] : "user" !== a.exact && "user" !== a.ideal || (c = ["front"]), c) return n.mediaDevices.enumerateDevices().then((function(e) {
                            ...
                            return !n && e.length && -1 !== c.indexOf("back") && (n = e[e.length - 1]), n && (t.video.deviceId = a.exact ? {
                                ...
                                ideal: n.deviceId
                            }), t.video = s(t.video), r("chrome: " + JSON.stringify(t)), i(t)
                        }));
                    t.video = s(t.video)
                }
    ...
    function r(t, e, n, r, s) {
        ...
        if (o += i.writeIceParameters(t.iceGatherer.getLocalParameters()), o += i.writeDtlsParameters(t.dtlsTransport.getLocalParameters(), "offer" === n ? "actpass" : s || "active"), o += "a=mid:" + t.mid + "\r\n", t.rtpSender && t.rtpReceiver ? o += "a=sendrecv\r\n" : t.rtpSender ? o += "a=sendonly\r\n" : t.rtpReceiver ? o += "a=recvonly\r\n" : o += "a=inactive\r\n", t.rtpSender) {
        ...
        return t.codecs.forEach((function(i) {
            for (var s = 0; s < e.codecs.length; s++) {
                ...
                if (i.name.toLowerCase() === o.name.toLowerCase() && i.clockRate === o.clockRate) {
                    if ("rtx" === i.name.toLowerCase() && i.parameters && o.parameters.apt && !r(i, o, t.codecs, e.codecs)) continue;
                    (o = JSON.parse(JSON.stringify(o))).numChannels = Math.min(i.numChannels, o.numChannels), n.codecs.push(o), o.rtcpFeedback = o.rtcpFeedback.filter((function(t) {
    ...
    function h(t, e, n, i) {
        ...
        r.track = e, r.receiver = n, r.transceiver = {
            receiver: n
        }, r.streams = i, window.setTimeout((function() {
    ...
    t.exports = function(t, e) {
        var n = function(n) {
            ...
            if (["addEventListener", "removeEventListener", "dispatchEvent"].forEach((function(t) {
                    r[t] = s[t].bind(s)
                })), this.canTrickleIceCandidates = null, this.needNegotiation = !1, this.localStreams = [], this.remoteStreams = [], this.localDescription = null, this.remoteDescription = null, this.signalingState = "stable", this.iceConnectionState = "new", this.iceGatheringState = "new", n = JSON.parse(JSON.stringify(n || {})), this.usingBundle = "max-bundle" === n.bundlePolicy, "negotiate" === n.rtcpMuxPolicy) {
            ...
            if (n.iceServers = function(t, e) {
                ...
                for (var a = n.iceCandidatePoolSize; a > 0; a--) this._iceGatherers = new t.RTCIceGatherer({
                    iceServers: n.iceServers,
                    gatherPolicy: n.iceTransportPolicy
                });
            else n.iceCandidatePoolSize = 0;
            this._config = n, this.transceivers = [], this._sdpSessionId = i.generateSessionId(), this._sdpSessionVersion = 0, this._dtlsRole = void 0
        };
        return n.prototype.onicecandidate = null, n.prototype.onaddstream = null, n.prototype.ontrack = null, n.prototype.onremovestream = null, n.prototype.onsignalingstatechange = null, n.prototype.oniceconnectionstatechange = null, n.prototype.onicegatheringstatechange = null, n.prototype.onnegotiationneeded = null, n.prototype.ondatachannel = null, n.prototype._dispatchEvent = function(t, e) {
            this.dispatchEvent(e), "function" == typeof this["on" + t] && this["on" + t](e)
            ...
            if (this.usingBundle && e) n.iceTransport = this.transceivers[0].iceTransport, n.dtlsTransport = this.transceivers[0].dtlsTransport;
            else {
            ...
            if (this.transceivers.find((function(t) {
                    return t.track === e
                }))) throw (i = new Error("Track already exists.")).name = "InvalidAccessError", i;
            if ("closed" === this.signalingState) throw (i = new Error("Attempted to call addTrack on a closed peerconnection.")).name = "InvalidStateError", i;
            for (var s = 0; s < this.transceivers.length; s++) this.transceivers[s].track || this.transceivers[s].kind !== e.kind || (r = this.transceivers[s]);
            return r || (r = this._createTransceiver(e.kind)), this._maybeFireNegotiationNeeded(), -1 === this.localStreams.indexOf(n) && this.localStreams.push(n), r.track = e, r.stream = n, r.rtpSender = new t.RTCRtpSender(e, r.dtlsTransport), r.rtpSender
            ...
            if (!n) {
                ...
                throw i.name = "InvalidAccessError", i
            }
            var r = n.stream;
            ...
            return Object.defineProperty(r, "state", {
                value: "new",
                writable: !0
            }), this.transceivers[e].candidates = [], this.transceivers[e].bufferCandidates = function(t) {
                var n = !t.candidate || 0 === Object.keys(t.candidate).length;
                r.state = n ? "completed" : "gathering", null !== i.transceivers[e].candidates && i.transceivers[e].candidates.push(t.candidate)
            ...
            if (!s.onlocalcandidate) {
                ...
                this.transceivers[n].candidates = null, s.removeEventListener("localcandidate", this.transceivers[n].bufferCandidates), s.onlocalcandidate = function(t) {
                    if (!(r.usingBundle && n > 0)) {
                        ...
                        c ? "new" !== s.state && "gathering" !== s.state || (s.state = "completed") : ("new" === s.state && (s.state = "gathering"), a.component = 1, o.candidate.candidate = i.writeCandidate(a));
                        ...
                        "gathering" !== r.iceGatheringState && (r.iceGatheringState = "gathering", r._emitGatheringStateChange()), c || r._dispatchEvent("icecandidate", o), h && (r._dispatchEvent("icecandidate", new Event("icecandidate")), r.iceGatheringState = "complete", r._emitGatheringStateChange())
                    }
                }, t.setTimeout((function() {
                    o.forEach((function(t) {
                        var e = new Event("RTCIceGatherEvent");
                        e.candidate = t, s.onlocalcandidate(e)
                    }))
                }), 0)
            }
            ...
            n && t.rtpSender && (o.encodings = t.sendEncodingParameters, o.rtcp = {
                cname: i.localCName,
                compound: t.rtcpParameters.compound
            }, t.recvEncodingParameters.length && (o.rtcp.ssrc = t.recvEncodingParameters[0].ssrc), t.rtpSender.send(o)), r && t.rtpReceiver && o.codecs.length > 0 && ("video" === t.kind && t.recvEncodingParameters && e < 15019 && t.recvEncodingParameters.forEach((function(t) {
                delete t.rtx
            })), t.recvEncodingParameters.length && (o.encodings = t.recvEncodingParameters), o.rtcp = {
                compound: t.rtcpParameters.compound
            }, t.rtcpParameters.cname && (o.rtcp.cname = t.rtcpParameters.cname), t.sendEncodingParameters.length && (o.rtcp.ssrc = t.sendEncodingParameters[0].ssrc), t.rtpReceiver.receive(o))
        }, n.prototype.setLocalDescription = function(t) {
            var e, n, r = this,
                a = arguments;
            if (!o("setLocalDescription", t.type, this.signalingState)) return new Promise((function(e, n) {
                var i = new Error("Can not set local " + t.type + " in state " + r.signalingState);
                i.name = "InvalidStateError", a.length > 2 && "function" == typeof a[2] && a[2].apply(null, [i]), n(i)
            }));
            if ("offer" === t.type) e = i.splitSections(t.sdp), n = e.shift(), e.forEach((function(t, e) {
                ...
                e = i.splitSections(r.remoteDescription.sdp), n = e.shift();
                ...
                e.forEach((function(t, e) {
                    ...
                    if (!(i.isRejected(t) && 0 === i.matchPrefix(t, "a=bundle-only").length) && !o.isDatachannel) {
                        ...
                        c && (f.role = "server"), r.usingBundle && 0 !== e || (r._gather(o.mid, e), "new" === u.state && u.start(a, p, c ? "controlling" : "controlled"), "new" === h.state && h.start(f));
                        var m = s(l, d);
            ...
            var r = this,
                s = arguments;
            if (!o("setRemoteDescription", n.type, this.signalingState)) return new Promise((function(t, e) {
                var i = new Error("Can not set remote " + n.type + " in state " + r.signalingState);
                i.name = "InvalidStateError", s.length > 2 && "function" == typeof s[2] && s[2].apply(null, [i]), e(i)
            }));
            var l = {};
            ...
            switch (this.canTrickleIceCandidates = !!v && v.substr(14).split(" ").indexOf("trickle") >= 0, p.forEach((function(s, o) {
                ...
                if ("application" !== p || "DTLS/SCTP" !== b) {
                    ...
                    v || (I = i.getIceParameters(s, f), (R = i.getDtlsParameters(s, f)).role = "client"), O = i.parseRtpEncodingParameters(s);
                    ...
                    if (("offer" === n.type || "answer" === n.type) && !v && g && o > 0 && r.transceivers[o] && (r._disposeIceAndDtlsTransports(o), r.transceivers[o].iceGatherer = r.transceivers[0].iceGatherer, r.transceivers[o].iceTransport = r.transceivers[0].iceTransport, r.transceivers[o].dtlsTransport = r.transceivers[0].dtlsTransport, r.transceivers[o].rtpSender && r.transceivers[o].rtpSender.setTransport(r.transceivers[0].dtlsTransport), r.transceivers[o].rtpReceiver && r.transceivers[o].rtpReceiver.setTransport(r.transceivers[0].dtlsTransport)), "offer" !== n.type || v) "answer" !== n.type || v || (T = (x = r.transceivers[o]).iceGatherer, S = x.iceTransport, C = x.dtlsTransport, k = x.rtpReceiver, E = x.sendEncodingParameters, M = x.localCapabilities, r.transceivers[o].recvEncodingParameters = O, r.transceivers[o].remoteCapabilities = P, r.transceivers[o].rtcpParameters = D, N.length && "new" === S.state && (!m && !j || g && 0 !== o ? N.forEach((function(t) {
                        a(x.iceTransport, t)
                    })) : S.setRemoteCandidates(N)), g && 0 !== o || ("new" === S.state && S.start(T, I, "controlling"), "new" === C.state && C.start(R)), r._transceive(x, "sendrecv" === y || "recvonly" === y, "sendrecv" === y || "sendonly" === y), !k || "sendrecv" !== y && "sendonly" !== y ? delete x.rtpReceiver : (A = k.track, _ ? (l[_.stream] || (l[_.stream] = new t.MediaStream), c(A, l[_.stream]), d.push([A, k, l[_.stream]])) : (l.default || (l.default = new t.MediaStream), c(A, l.default), d.push([A, k, l.default]))));
                    else {
                        (x = r.transceivers[o] || r._createTransceiver(p)).mid = w, x.iceGatherer || (x.iceGatherer = r._createIceGatherer(o, g)), N.length && "new" === x.iceTransport.state && (!j || g && 0 !== o ? N.forEach((function(t) {
                            a(x.iceTransport, t)
                        })) : x.iceTransport.setRemoteCandidates(N)), M = t.RTCRtpReceiver.getCapabilities(p), e < 15019 && (M.codecs = M.codecs.filter((function(t) {
                            return "rtx" !== t.name
                        ...
                        if ("sendrecv" === y || "sendonly" === y) {
                            if (B = !x.rtpReceiver, k = x.rtpReceiver || new t.RTCRtpReceiver(x.dtlsTransport, p), B) A = k.track, _ && "-" === _.stream || (_ ? (l[_.stream] || (l[_.stream] = new t.MediaStream, Object.defineProperty(l[_.stream], "id", {
                                get: function() {
                                    return _.stream
                                }
                            ...
                            }), L = l[_.stream]) : (l.default || (l.default = new t.MediaStream), L = l.default)), L && (c(A, L), x.associatedRemoteMediaStreams.push(L)), d.push([A, k, L])
                        } else x.rtpReceiver && x.rtpReceiver.track && (x.associatedRemoteMediaStreams.forEach((function(t) {
                            var e = t.getTracks().find((function(t) {
                                return t.id === x.rtpReceiver.track.id
                            }));
                            e && u(e, t)
                        })), x.associatedRemoteMediaStreams = []);
                        x.localCapabilities = M, x.remoteCapabilities = P, x.rtpReceiver = k, x.rtcpParameters = D, x.sendEncodingParameters = E, x.recvEncodingParameters = O, r._transceive(r.transceivers[o], !1, B)
                    }
            ...
            }), 4e3), new Promise((function(t) {
                s.length > 1 && "function" == typeof s[1] && s[1].apply(null), t()
            }))
            ...
            if (n) {
                ...
                void 0 !== n.offerToReceiveAudio && (a = !0 === n.offerToReceiveAudio ? 1 : !1 === n.offerToReceiveAudio ? 0 : n.offerToReceiveAudio), void 0 !== n.offerToReceiveVideo && (c = !0 === n.offerToReceiveVideo ? 1 : !1 === n.offerToReceiveVideo ? 0 : n.offerToReceiveVideo)
            }
            for (this.transceivers.forEach((function(t) {
                    "audio" === t.kind ? --a < 0 && (t.wantReceive = !1) : "video" === t.kind && --c < 0 && (t.wantReceive = !1)
                })); a > 0 || c > 0;) a > 0 && (this._createTransceiver("audio"), a--), c > 0 && (this._createTransceiver("video"), c--);
            ...
            this.transceivers.forEach((function(n, r) {
                ...
                n.mid = c, n.iceGatherer || (n.iceGatherer = s._createIceGatherer(r, s.usingBundle));
            ...
            return new Promise((function(t) {
                if (o.length > 0 && "function" == typeof o[0]) return o[0].apply(null, [h]), void t();
                t(h)
            }))
            ...
            this.transceivers.forEach((function(t, i) {
                if (!(i + 1 > c))
                    if (t.isDatachannel) a += "m=application 0 DTLS/SCTP 5000\r\nc=IN IP4 0.0.0.0\r\na=mid:" + t.mid + "\r\n";
                    else {
                        var o;
                        if (t.stream) "audio" === t.kind ? o = t.stream.getAudioTracks()[0] : "video" === t.kind && (o = t.stream.getVideoTracks()[0]), o && e >= 15019 && "video" === t.kind && !t.sendEncodingParameters[0].rtx && (t.sendEncodingParameters[0].rtx = {
                        ...
                        })).length && t.sendEncodingParameters[0].rtx && delete t.sendEncodingParameters[0].rtx, a += r(t, u, "answer", t.stream, n._dtlsRole), t.rtcpParameters && t.rtcpParameters.reducedSize && (a += "a=rtcp-rsize\r\n")
                    }
            }));
            ...
            return new Promise((function(t) {
                if (o.length > 0 && "function" == typeof o[0]) return o[0].apply(null, [u]), void t();
                t(u)
            }))
        }, n.prototype.addIceCandidate = function(t) {
            var e, n;
            if (t && "" !== t.candidate) {
                if (void 0 === t.sdpMLineIndex && !t.sdpMid) throw new TypeError("sdpMLineIndex or sdpMid required");
                if (this.remoteDescription) {
                    ...
                    if (o) {
                        ...
                        if ("tcp" === c.protocol && (0 === c.port || 9 === c.port)) return Promise.resolve();
                        if (c.component && 1 !== c.component) return Promise.resolve();
                        if ((0 === r || r > 0 && o.iceTransport !== this.transceivers[0].iceTransport) && (a(o.iceTransport, c) || ((e = new Error("Can not add ICE candidate")).name = "OperationError")), !e) {
                            var u = t.candidate.trim();
                            0 === u.indexOf("a=") && (u = u.substr(2)), (n = i.splitSections(this.remoteDescription.sdp))[r + 1] += "a=" + (c.type ? u : "end-of-candidates") + "\r\n", this.remoteDescription.sdp = n.join("")
                        }
                    } else(e = new Error("Can not add ICE candidate")).name = "OperationError"
                } else(e = new Error("Can not add ICE candidate without a remote description")).name = "InvalidStateError"
            } else
                for (var h = 0; h < this.transceivers.length && (this.transceivers[h].isDatachannel || (this.transceivers[h].iceTransport.addRemoteCandidate({}), (n = i.splitSections(this.remoteDescription.sdp))[h + 1] += "a=end-of-candidates\r\n", this.remoteDescription.sdp = n.join(""), !this.usingBundle)); h++);
            var l = arguments;
            return new Promise((function(t, n) {
                e ? (l.length > 2 && "function" == typeof l[2] && l[2].apply(null, [e]), n(e)) : (l.length > 1 && "function" == typeof l[1] && l[1].apply(null), t())
            }))
                ...
                Promise.all(t).then((function(t) {
                    t.forEach((function(t) {
                        Object.keys(t).forEach((function(e) {
                            t[e].type = n(t[e]), r.set(e, t[e])
                        }))
                    })), e && e.apply(null, r), i(r)
                }))
            }))
        }, n
    }
                            ...
                            for (var r = [], s = 0; s < n.iceServers.length; s++) {
                                ...
                                if (o.hasOwnProperty("urls"))
                                    for (var a = 0; a < o.urls.length; a++) {
                                        ...
                                        0 === o.urls[a].indexOf("turn") && (c.username = o.username, c.credential = o.credential), r.push(c)
                                    } else r.push(n.iceServers[s])
                            }
                            n.iceServers = r
                        }
    ...
    t.exports = function(t) {
        ...
        n.getUserMedia = function(t, r, s) {
            if (e.version < 44) return a(t, r, s);
            i.deprecated("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"), n.mediaDevices.getUserMedia(t).then(r, s)
        }
    }
}, function(t, e, n) {
    "use strict";
        ...
        r = {
            ...
            shimRemoteStreamsAPI: function(t) {
                "object" == typeof t && t.RTCPeerConnection && ("getRemoteStreams" in t.RTCPeerConnection.prototype || (t.RTCPeerConnection.prototype.getRemoteStreams = function() {
                    ...
                    set: function(t) {
                        this._onaddstream && (this.removeEventListener("addstream", this._onaddstream), this.removeEventListener("track", this._onaddstreampoly)), this.addEventListener("addstream", this._onaddstream = t), this.addEventListener("track", this._onaddstreampoly = function(t) {
                            var e = t.streams[0];
                            if (this._remoteStreams || (this._remoteStreams = []), !(this._remoteStreams.indexOf(e) >= 0)) {
                                this._remoteStreams.push(e);
                                var n = new Event("addstream");
                                n.stream = t.streams[0], this.dispatchEvent(n)
                            }
                        }.bind(this))
                    }
                }))
            ...
            shimRTCIceServerUrls: function(t) {
                ...
                t.RTCPeerConnection = function(t, n) {
                    if (t && t.iceServers) {
                        for (var r = [], s = 0; s < t.iceServers.length; s++) {
                            var o = t.iceServers[s];
                            !o.hasOwnProperty("urls") && o.hasOwnProperty("url") ? (i.deprecated("RTCIceServer.url", "RTCIceServer.urls"), (o = JSON.parse(JSON.stringify(o))).urls = o.url, delete o.url, r.push(o)) : r.push(t.iceServers[s])
                        }
                        t.iceServers = r
                    }
                    return new e(t, n)
                    ...
                    function(t, e, n) {
                        if (t.RTCPeerConnection) {
                            ...
                            i.addEventListener = function(t, i) {
                                ...
                                return this._eventMap = this._eventMap || {}, this._eventMap[i] = s, r.apply(this, [t, s])
                            };
                            var s = i.removeEventListener;
                            i.removeEventListener = function(t, n) {
                                if (t !== e || !this._eventMap || !this._eventMap[n]) return s.apply(this, arguments);
                                var i = this._eventMap[n];
                                return delete this._eventMap[n], s.apply(this, [t, i])
        ...
        shimCreateObjectURL: function(t) {
            ...
            if ("object" == typeof t && t.HTMLMediaElement && "srcObject" in t.HTMLMediaElement.prototype && e.createObjectURL && e.revokeObjectURL) {
                ...
                e.createObjectURL = function(t) {
                    if ("getTracks" in t) {
                        var e = "polyblob:" + ++o;
                        return s.set(e, t), r.deprecated("URL.createObjectURL(stream)", "elem.srcObject = stream"), e
                    }
                    return n(t)
                ...
                Object.defineProperty(t.HTMLMediaElement.prototype, "src", {
                    ...
                    set: function(t) {
                        return this.srcObject = s.get(t) || null, a.set.apply(this, [t])
                    }
                });
                var c = t.HTMLMediaElement.prototype.setAttribute;
                t.HTMLMediaElement.prototype.setAttribute = function() {
                    return 2 === arguments.length && "src" === ("" + arguments[0]).toLowerCase() && (this.srcObject = s.get(arguments[1]) || null), c.apply(this, arguments)
                }
            }
        }
    }
    ...
    (e = n(24)(!1)).push([t.i, '@keyframes dash{0%{stroke-dashoffset:120}50%{stroke-dashoffset:30;transform:rotate(240deg)}100%{stroke-dashoffset:120;transform:rotate(720deg)}}#gamepad{position:absolute;height:48px;padding:7px 9px;border-radius:24px;z-index:1;left:65px;top:14px}#gamepad .button{height:34px;width:34px;padding-top:34px;overflow:hidden;display:none;background:transparent;position:relative;margin-left:9px;float:left}#gamepad .button:before{background-image:url(/client/images/gamepad/left.svg);content:"\\a";position:absolute;height:32px;width:32px;display:block;top:1px;left:1px;background-position:center;background-repeat:no-repeat;background-size:contain}#gamepad::before{content:"\\a"}#gamepad #gamepad-toggle-button{display:inline-block;margin-left:0}#gamepad #gamepad-toggle-button::before{background-image:url(/client/images/icon-gamepad.svg);background-size:83%;background-color:transparent;border-radius:0}#gamepad #gamepad-up-button::before{background-image:url(/client/images/gamepad/up.svg)}#gamepad #gamepad-down-button::before{background-image:url(/client/images/gamepad/down.svg)}#gamepad #gamepad-right-button::before{background-image:url(/client/images/gamepad/right.svg)}#gamepad #gamepad-return-button{width:65px}#gamepad #gamepad-return-button::before{width:63px;background-image:url(/client/images/gamepad/return.svg)}#gamepad.expand{background:rgba(0,0,0,.05);border-color:rgba(0,0,0,.03)}#gamepad.expand .button{display:inline-block}#gamepad.expand #gamepad-toggle-button::before{background-image:url(/client/images/icon-x.svg);background-size:67%;border:1px transparent solid}@media(max-width: 767px){#gamepad{display:none}}', ""]), e.locals = {
        blue: "#16a8f0",
        red: "red",
        lightGrayFill: "#e6e6e6",
        darkGrayFill: "#a0a0a0",
    ...
    function l(t, e, n) {
        ...
        return i.forEach(n => {
            var i = n + e + 12 * r;
            Math.abs(i - t) < o && (o = Math.abs(i - t), s = i)
        }), s
    }
    ...
    function F(t, e, n = [], i) {
        ...
        if (T(s[0]) && i && !Reflect.has(s[0], i)) {
            Object.keys(s[0]).some(e => Reflect.has(t, e)) || (U(r, {
                [i]: s[0]
            }), n.splice(n.indexOf(i), 1), s.shift())
        }
        if (1 === s.length && T(s[0])) U(r, s[0]);
        else
            for (let t = 0; t < n.length; t++) w(s[t]) && (r[n[t]] = s[t]);
        return U(t, r)
    }
    ...
    class ot extends z {
        constructor() {
            ...
            this.reverse = t.reverse, this.onload = t.onload, t.url && L(t.url) || t.url instanceof ot ? this.set(t.url) : k(t.url) && this.load(t.url).catch(t.onerror)
        }
        static getDefaults() {
            return {
                onerror: st,
        ...
        fromArray(t) {
            const e = C(t) && t[0].length > 0,
                ...
                o = e || 1 !== n ? t : [t];
            for (let t = 0; t < n; t++) s.copyToChannel(o[t], t);
        ...
        slice(t, e = this.duration) {
            ...
            for (let t = 0; t < this.numberOfChannels; t++) s.copyToChannel(this.getChannelData(t).subarray(n, i), t);
            return new ot(s)
        }
        _reverse() {
            if (this.loaded)
        ...
        apply(t) {
            ...
            if (n && "setTargetAtTime" === n.type) {
                const i = this._events.getAfter(n.time),
                    r = i ? i.time : e + 2,
                    s = (r - e) / 10;
                for (let n = e; n < r; n += s) t.linearRampToValueAtTime(this.getValueAtTime(n), n)
            }
    ...
    function At(...t) {
        const e = t.shift();
        t.reduce((t, e) => (t instanceof Mt ? t.connect(e) : D(t) && It(t, e), e), e)
    }
    ...
    class Dt extends Mt {
        constructor(t) {
            super(t), this.onended = st, this._startTime = -1, this._stopTime = -1, this._timeout = -1, this.output = new Pt({
                context: this.context,
                gain: 0
        ...
        _onended() {
            this.onended !== st && (this.onended(this), this.onended = st, this.context.isOffline || setTimeout(() => this.dispose(), 1e3))
        }
        get state() {
    ...
    class jt extends Dt {
        constructor() {
            ...
            It(this._source, this._gainNode), this.offset = new Ot({
                context: this.context,
                convert: t.convert,
    ...
    function Lt(t, e, n, i) {
        (e instanceof Ot || P(e) || e instanceof Nt && e.override) && (e.cancelScheduledValues(0), e.setValueAtTime(0, 0), e instanceof Nt && (e.overridden = !0)), It(t, e, n, i)
    }
    class Bt extends Ot {
        constructor() {
        ...
        setValueAtTime(t, e) {
            ...
            return i.ticks = Math.max(s, 0), this
        }
        linearRampToValueAtTime(t, e) {
            const n = this.toSeconds(e);
    ...
    class Ft extends kt {
        ...
        getTicksAtTime(t) {
            ...
            return this._state.forEachBetween(n.time, e + this.sampleTime, t => {
                ...
                n && n.time >= r.time && (s = n.ticks, e = n.time), "started" === r.state && "started" !== t.state && (s += this.frequency.getTicksAtTime(t.time) - this.frequency.getTicksAtTime(e)), r = t
            }), this._state.remove(i), s
        }
        get ticks() {
    ...
    class Vt extends kt {
        constructor() {
            super(F(Vt.getDefaults(), arguments, ["callback", "frequency"])), this.name = "Clock", this.callback = st, this._lastUpdate = 0, this._state = new Et("stopped"), this._boundLoop = this._loop.bind(this);
    ...
    class Jt extends Mt {
        constructor() {
            ...
            At(this.input, this.output, this.context.rawContext.destination), this.mute = t.mute, this._internalChannels = [this.input, this.context.rawContext.destination, this.output]
        }
        static getDefaults() {
            return Object.assign(Mt.getDefaults(), {
                mute: !1,
        ...
        chain(...t) {
            return this.input.disconnect(), t.unshift(this.input), t.push(this.output), At(...t), this
        }
        get maxChannelCount() {
    ...
    class $t extends z {
        ...
        add(t, e, n = st, i = st) {
            return k(e) ? this._buffers.set(t.toString(), new ot(this.baseUrl + e, n, i)) : this._buffers.set(t.toString(), new ot(e, n, i)), this
        }
        dispose() {
    ...
    class Kt extends Mt {
        constructor(t) {
            super(t), this.input = void 0, this._state = new Et("stopped"), this._synced = !1, this._scheduled = [], this._syncedStart = st, this._syncedStop = st, this._state.memory = 100, this._state.increasing = !0, this._volume = this.output = new Zt({
                context: this.context,
                mute: t.mute,
                volume: t.volume
    ...
    class te extends Dt {
        constructor() {
            ...
            It(this._source, this._gainNode), this._source.onended = () => this._stopSource(), this.playbackRate = new Ot({
                context: this.context,
        ...
        start(t, e, n, i = 1) {
            ...
            if (this.loop) {
                const t = this.toSeconds(this.loopEnd) || this.buffer.duration,
                    ...
                    n = t - e;
                H(s, t) && (s = (s - e) % n + e), Y(s, this.buffer.duration) && (s = 0)
            }
            if (this._source.buffer = this.buffer.get(), this._source.loopEnd = this.toSeconds(this.loopEnd) || this.buffer.duration, W(s, this.buffer.duration) && (this._sourceStarted = !0, this._source.start(r, s)), w(n)) {
        ...
        open(t) {
            return I(this, void 0, void 0, (function*() {
                ...
                if (!this._stream) {
                    ...
                    It(t, this.output), this._mediaStream = t
                }
                return this
            }))
        }
    ...
    class ie extends Dt {
        constructor() {
            ...
            It(this._oscillator, this._gainNode), this.type = t.type, this.frequency = new Ot({
                context: this.context,
    ...
    class re extends Kt {
        ...
        _getRealImaginary(t, e) {
            ...
            let s = 1;
            if ("custom" === t) {
                if (s = this._partials.length + 1, this._partialCount = this._partials.length, n = s, 0 === this._partials.length) return [i, r]
            } else {
                const e = /^(sine|triangle|square|sawtooth)(\d+)$/.exec(t);
                e ? (s = parseInt(e[2], 10) + 1, this._partialCount = parseInt(e[2], 10), t = e[1], s = Math.max(s, 2), n = s) : this._partialCount = 0, this._partials = []
            }
            for (let o = 1; o < n; ++o) {
                const n = 2 / (o * Math.PI);
                let a;
                switch (t) {
                    case "sine":
                        a = o <= s ? 1 : 0, this._partials[o - 1] = a;
                        break;
                    case "square":
                        a = 1 & o ? 2 * n : 0, this._partials[o - 1] = a;
                        break;
                    case "sawtooth":
                        a = n * (1 & o ? 1 : -1), this._partials[o - 1] = a;
                        break;
                    case "triangle":
                        a = 1 & o ? n * n * 2 * (o - 1 >> 1 & 1 ? -1 : 1) : 0, this._partials[o - 1] = a;
                        break;
                    case "custom":
                ...
                0 !== a ? (i[o] = -a * Math.sin(e * o), r[o] = a * Math.cos(e * o)) : (i[o] = 0, r[o] = 0)
            }
            return [i, r]
        }
        _inverseFFT(t, e, n) {
            let i = 0;
            const r = t.length;
            for (let s = 0; s < r; s++) i += t[s] * Math.cos(s * n) + e[s] * Math.sin(s * n);
            return i
        }
        getInitialValue() {
    ...
    class oe extends se {
        constructor() {
            super(Object.assign(F(oe.getDefaults(), arguments, ["mapping", "length"]))), this.name = "WaveShaper", this._shaper = this.context.createWaveShaper(), this.input = this._shaper, this.output = this._shaper;
    ...
    class ae extends se {
        constructor() {
            super(...arguments), this.name = "AudioToGain", this._norm = new oe({
                context: this.context,
                mapping: t => (t + 1) / 2
    ...
    class be extends Kt {
        ...
        _start(t, e, n) {
            ...
            s /= this._playbackRate, t = this.toSeconds(t);
            const o = new te({
                url: this._buffer,
                context: this.context,
                fadeIn: this.fadeIn,
            ...
            this._loop || this._synced || (this._state.cancel(t + s), this._state.setStateAtTime("stopped", t + s, {
                implicitEnd: !0
            })), this._activeSources.add(o), this._loop && _(r) ? o.start(t, i) : o.start(t, i, s - this.toSeconds(this.fadeOut))
        }
        _stop(t) {
            const e = this.toSeconds(t);
    ...
    A([ve(0)], be.prototype, "fadeIn", void 0), A([ve(0)], be.prototype, "fadeOut", void 0);
    class ye extends Mt {
        constructor() {
        ...
        triggerAttack(t, e = 1) {
            ...
            if (i && this.sustain < 1) {
                const r = e * this.sustain,
                    s = t + n;
                this.log("decay", s), "linear" === this._decayCurve ? this._sig.linearRampToValueAtTime(r, i + s) : this._sig.exponentialApproachValueAtTime(r, s, i)
            }
            return this
        }
        triggerRelease(t) {
        ...
        asArray(t = 1024) {
            return I(this, void 0, void 0, (function*() {
                ...
                return a._sig.toDestination(), a.triggerAttackRelease(e * (i + s) / o, 0), (yield n.render()).getChannelData(0)
            }))
        }
        dispose() {
    ...
    A([ve(0)], ye.prototype, "attack", void 0), A([ve(0)], ye.prototype, "decay", void 0), A([ge(0, 1)], ye.prototype, "sustain", void 0), A([ve(0)], ye.prototype, "release", void 0);
    const _e = (() => {
        let t, e;
        const n = [];
        ...
        const s = [];
        for (t = 0; t < 128; t++) e = t / 127, s[t] = .5 * (1 - Math.cos(Math.PI * e));
        const o = [];
        for (t = 0; t < 128; t++) {
            e = t / 127;
    ...
    class we extends Mt {
        ...
        triggerAttackRelease(t, e, n, i) {
            const r = this.toSeconds(n),
                s = this.toSeconds(e);
            return this.triggerAttack(t, r, i), this.triggerRelease(r + s), this
        }
        dispose() {
    ...
    A([ge(0)], Ce.prototype, "octaves", void 0), A([ve(0)], Ce.prototype, "pitchDecay", void 0);
    const ke = new Set;
    ...
    class Me extends we {
        ...
        triggerAttack(t, e, n = 1) {
            return this.log("triggerAttack", t, e, n), Array.isArray(t) || (t = [t]), t.forEach(t => {
                ...
                c.start(e, 0, o.duration / a, n), C(this._activeSources.get(i)) || this._activeSources.set(i, []), this._activeSources.get(i).push(c), c.onended = () => {
    ...
    A([ve(0)], Me.prototype, "attack", void 0), A([ve(0)], Me.prototype, "release", void 0);
    class Ae extends kt {
        constructor() {
            super(F(Ae.getDefaults(), arguments, ["callback", "value"])), this.name = "ToneEvent", this._state = new Et("stopped"), this._startOffset = 0;
    ...
    class Ie extends Ae {
        constructor() {
            super(F(Ie.getDefaults(), arguments, ["callback", "events"])), this.name = "Part", this._state = new Et("stopped"), this._events = new Set;
        ...
        add(t, e) {
            ...
            const n = this.toTicks(t);
            let i;
            return e instanceof Ae ? (i = e, i.callback = this._tick.bind(this)) : i = new Ae({
    ...
    class He extends i.EventEmitter {
        ...
        morph(t, e) {
            ...
            this.timeline.forEach(i => {
                ...
                try {
                    r = this.morphTiming(a, t, e), s = this.morphPitch(s, t, e), null === Ge(n, r, s) && n.add({
                        time: r,
                        note: s,
                        duration: o
                    })
        ...
        add(t, e) {
            ...
            if (!this.has(t, e)) {
                ...
                return this.timeline.add(s), i && r.emit("history:push", {
                    type: "add",
                    time: t,
                    note: e,
                    duration: n,
    ...
    ! function() {
        for (var [t, e] of Object.entries(Je))
            for (var [n, i] of (Qe[t] = {}, Object.entries(e))) Qe[t][n] = new ot(i);
        for (var [r, s] of Object.entries($e))
            for (var [o, a] of (Qe[r] = {}, Object.entries(s))) Qe[r][o] = new ot(a)
    }();
    var Ke = {
        piano: 1,
        marimba: 13,
    ...
    function sn(t, e) {
        ...
        }), i.length && i.push(on(e.totalSubBeats)), rn(i, e)
    }
    ...
    class vn {
        constructor(t, e, n, i) {
            ...
            this.options = t, this.part = new Ie(this.onnote.bind(this)).start(0), this.hotMic = !1, this.track = e, r || (this.track.on("add", t => this.addNote(t)), this.track.on("remove", t => this.removeNote(t)), this.track.on("touch", t => {
                ...
                function(t, e, n = 2, i = ht().sampleRate) {
                    ...
                    var t, n = (t = function*(t) {
                        ...
                        var r = new vn(e.options, e.midiData.instrument, !1, () => {}, !0, !0),
                            s = new vn(e.options, e.midiData.percussion, !0, () => {}, !0, !0);
                        r.syncWithMidiTrack(), s.syncWithMidiTrack(), n.start()
                    }, function() {
                        var e = this,
                            n = arguments;
                        return new Promise((function(i, r) {
                    ...
                    ! function(t, e) {
                        ...
                        n.href = s, n.download = e + ".wav", n.click(), window.URL.revokeObjectURL(s)
    ...
    class Vn extends class {
        ...
        draw(t, e, n, i, r, s) {
            ...
            this.drawBars(e, n), this.drawPositionIndicator(e, n, o), r.x > -1 && r.x !== o && this.drawPositionIndicator(e, n, r.x), this.drawNotes(e, n, o, s), this.drawGrid(e, n);
            var a = !0;
        ...
        drawBars(t, e) {
            ...
            for (var s = i; s < this.bounds.xMax; s += n) s / n % 2 < 1 && this.context.fillRect(s * this.tileWidth * this.dpi - e.x * this.dpi, 0, r, this.height * this.dpi)
        }
        ...
        drawNotes(t, e, n, i) {
            for (var r = this.bounds.yMin; r < this.bounds.yMax; r++)
                for (var s = this.bounds.xMin; s < this.bounds.xMax; s++) {
                    ...
                    if (o) {
                        var a = An(o);
                        this.context.fillStyle = kn.a.mix(a, "white", 100 * i[s].on).toRgbString(), this.context.fillRect(s * this.tileWidth * this.dpi - e.x * this.dpi, r * this.tileHeight * this.dpi - e.y * this.dpi, this.tileWidth * this.dpi, this.tileHeight * this.dpi)
                    }
                }
        }
        drawGrid(t, e) {
            ...
            for (var r = this.bounds.xMin + 1; r < this.bounds.xMax; r++) {
                ...
                var s = 1;
                this.isEmbed && (s = .5), this.context.fillRect(r * this.tileWidth * this.dpi - e.x * this.dpi, 0, s * this.dpi, this.height * this.dpi)
            }
        }
    }
    class zn extends Sn {
    ...
    class Hn extends Vn {
            ...
            for (var r = this.bounds.yMin; r < this.bounds.yMax; r++)
                for (var s = this.bounds.xMin; s < this.bounds.xMax; s++) {
                    ...
                    if (void 0 !== o) {
                        var u = Rn,
                            h = 0;
                        this.context.fillStyle = kn.a.mix(u, "white", 100 * i[s].on).toRgbString(), h = Math.min(this.tileWidth, this.tileHeight) * (.23 + .17 * i[s].on), this.isEmbed ? h *= 1.25 : h *= 1.35, 1 === r ? this.drawCircle(a, c, .9 * h) : this.drawTriangle(a, c, h)
                    } else {
        ...
        drawGrid(t, e) {
            ...
            var r = this.isEmbed ? jn : Un,
                s = this.isEmbed ? 1 : 3;
            this.context.fillStyle = r, this.context.fillRect(0, 0, this.width * this.dpi, s * this.dpi)
        }
    }
    class Wn extends Sn {
        constructor() {
    ...
    class $n extends i.EventEmitter {
        ...
        fitBars() {
            ...
            for (var i = !0; i;) {
                ...
                (s > e.width + .01 || o > e.height + .01) && (i = !1, t.bars -= 1)
            }
        ...
        resize() {
            ...
            if (!this.isEmbed && i > t.width + .01) {
            ...
            }!this.isEmbed && s.h && this.scrollbars.h.show(), !this.isEmbed && s.v && this.scrollbars.v.show(), 0 === s.v && s.h > 0 ? this.scrollbars.h.full() : this.scrollbars.h.full(!1), this.instrument.resize({
                tileWidth: n.width,
                tileHeight: n.height,
                ...
                canvasWidth: t.width - s.v,
                canvasHeight: e
            }), this.percussion.renderer.canvas.style.bottom = s.h + "px", this.scrollbars.h.resizeThumb((t.width - s.v) / (this.songOptions.totalSubBeats * n.width)), this.scrollbars.v.resizeThumb((t.height - s.h) / (this.songOptions.totalNotes * n.height));
    ...
    class gi {
        ...
        drawCircle(t, e, n, i, r, s, o) {
            t.strokeStyle = r, t.lineWidth = o, t.beginPath();
        ...
        drawArrow(t, e, n, i) {
            ...
            t.fillStyle = mi.setAlpha(r).toRgbString(), t.beginPath(), t.moveTo((e + c.x) * s, (n + c.y) * s), t.lineTo((e + u.x) * s, (n + u.y) * s), t.lineTo((e + h.x) * s, (n + h.y) * s), t.closePath(), t.fill()
        }
        rotatePoint(t, e, n) {
            var i = this.cx,
                r = this.cy;
        ...
        render(t, e, n, i, r) {
            ...
            this.image && s.drawImage(this.image, (a + this.cx - .5 * this.imageW) * o, (h + this.cy - .5 * this.imageH) * o, this.imageW * o, this.imageH * o), this.drawCircle(s, a, h, this.innerR, In, n, o), this.drawCircle(s, a, h, this.outerR, fi, n, o);
            var l = this.pitchIndex ? this.pitchIndex : r.y,
                d = (e.flipY(l) + .5) * t.tileHeight - i.y,
                p = Math.atan2(h + this.cy - d, this.cx);
            this.isFlipped && (p = Math.PI - p), this._angle.goal = p, this._angle.step(), this.arrowO.step(), this.drawArrow(s, a, h, this._angle.value, this.arrowO.value, o), s.fillStyle = kn()(An(this.pitch)).setAlpha(this.probability).toRgbString(), s.fillRect((r.x * t.tileWidth - i.x) * o, (c * t.tileHeight - i.y) * o, t.tileWidth * o, t.tileHeight * o), t.drawSelectionBox(e, r, i, this.probability)
        }
    }
    n(733);
    ...
    class Ci extends Si {
        ...
        setupQuantity(t) {
            ...
            e.classList.add("quantity-nav"), t.appendChild(e), a.classList.add("quantity-cover"), o.classList.add("quantity-label"), n.classList.add("quantity-button", "quantity-up"), i.classList.add("quantity-button", "quantity-down"), e.appendChild(n), e.appendChild(i), e.appendChild(o), e.appendChild(a), r.setAttribute("src", "images/icon-quantity-add.svg"), s.setAttribute("src", "images/icon-quantity-minus.svg"), n.appendChild(r), i.appendChild(s), o.innerHTML = d, a.value = c.value, a.addEventListener("change", () => {
                m(a.value)
    ...
    class Ii extends Si {
        constructor() {
            super(Ai.a), this.modal = document.getElementById("back-modal"), this.cancelButton = this.modal.querySelector("#back-modal-cancel"), this.confirmButton = this.modal.querySelector("#back-modal-confirm"), this.cancelButton.addEventListener("click", t => {
    ...
    class Di extends Si {
        ...
        exportStart() {
            document.getElementById("download-wav").style.pointerEvents = "none", document.getElementById("download-wav").innerText = "Loading…"
        }
        exportEnd() {
        ...
        selectAndCopy(t) {
            if (document.body.createTextRange) {
                ...
                if (s.removeAllRanges(), s.addRange(r), "TEXTAREA" != t.nodeName && "INPUT" != t.nodeName || t.select(), t.setSelectionRange && navigator.userAgent.match(/ipad|ipod|iphone/i) && t.setSelectionRange(0, 999999), t.contentEditable = n, t.readOnly = i, document.queryCommandSupported("copy")) document.execCommand("copy") ? console.log(t, "Copied to clipboard.") : console.log(t, "Press CTRL+C to copy");
        ...
        setUpButtons() {
            ...
            }), this.setTryCopy("copy-link", ".short-url"), this.setTryCopy("copy-iframe", ".iframe-code"), document.getElementById("download-midi").addEventListener("click", () => {
        ...
        constructor() {
            ...
            super(), t = this, this.modals = {
                ...
                Ti({
                    eventCategory: "top",
                    eventLabel: "back"
                }), t.preventDefault(), i.instrument.timeline._length < 1 && i.percussion.timeline._length < 1 ? this.emit("back") : this.modals.back || (this.modals.back = new Ii, this.modals.back.on("cancel", () => {
                    this.modals.back = !1
    ...
    class Wi extends i.EventEmitter {
        ...
        setId(t) {
            this.currentURL = "/song/".concat(t), window.history.pushState({}, "Song ".concat(t), this.currentURL)
        }
        clear() {
            this.currentURL = "/", window.history.pushState({}, "Song Maker", this.currentURL)
        }
    }
    ...
    }), rr.on("play-delete-sound", () => nr.playDelete()), rr.on("song-changed", () => sr()), new class {
        constructor(t) {
    ...
    ur.on("settings-update", or), r.on("history:pop:save", t => {
    ...
    hr.on("play", t => {
        ...
        nr.options.instrument = t, nr.options.changeInstrument(), sr()
    }), hr.on("percussion-change", t => {
        nr.options.percussion = t, nr.options.changeInstrument(), sr()
    }), hr.on("tempo", t => {
    ...
    }))), hr.on("settings-update", or), cr.on("start", () => {
    ...
    var dr = new class {
        ...
        loadSong(t) {
            if (this.load(t), document.getElementById("edit-link")) {
                ...
                var n = document.createElement("a");
                n.id = "edit-link", n.textContent = "Edit with Song Maker", n.setAttribute("target", "_blank"), n.setAttribute("href", "/song/" + t), document.body.appendChild(n)
            }
        }
        save() {
            var t = this;
        ...
        load(t) {
            ...
            return Xi((function*() {
                ...
                var n = fetch("https://storage.googleapis.com/song-maker-midifiles-prod/".concat(t, ".mid")).then(e => {
                        ...
                        throw window.location = "/", new Error("could not load midi file ".concat(t))
                    }),
                    i = fetch("".concat("/data", "/").concat(t), {
                        method: "POST"
                    }).then(e => {
                        if (e.ok) return e.json();
                        throw window.location = "/", new Error("could not load data file ".concat(t))
                    }),
                    [r, s] = yield Promise.all([n, i]);
                e.options.fromJSON(s), e.midiData.decode(r, e.options)
            }))()
        }
        clear() {
            this.url.clear()
