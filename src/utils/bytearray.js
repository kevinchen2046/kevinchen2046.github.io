...
var ByteArray = /** @class */ (function () {
    ...
    ByteArray.prototype.compress=function(){
        var deflate = new require('./zlib.beauty.js').Zlib.Deflate(new Uint8Array(this.buffer));
    ...
    ByteArray.prototype.uncompress=function(){
        var inflate = new require('./zlib.beauty.js').Zlib.Inflate(new Uint8Array(this.buffer));
        var inbuffer = inflate.decompress();
        this.buffer = inbuffer.buffer;
        this.position = 0;
    }
    
    ByteArray.compress=function(inputBuffer){
        var deflate = new require('./zlib.beauty.js').Zlib.Deflate(new Uint8Array(inputBuffer));
        var inbuffer = deflate.compress();
        return inbuffer.buffer;
    }

    ByteArray.uncompress=function(inputBuffer){
        var inflate = new require('./zlib.beauty.js').Zlib.Inflate(new Uint8Array(inputBuffer));
        var inbuffer = inflate.decompress();
        return inbuffer.buffer;
    }
    return ByteArray;
